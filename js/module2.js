...
var instructionsHr = require('./languages/translations/hr.json');
...
},{"./languages/abbreviations/bg.json":3,"./languages/abbreviations/ca.json":4,"./languages/abbreviations/da.json":5,"./languages/abbreviations/de.json":6,"./languages/abbreviations/en.json":7,"./languages/abbreviations/es.json":8,"./languages/abbreviations/fr.json":9,"./languages/abbreviations/he.json":10,"./languages/abbreviations/hu.json":11,"./languages/abbreviations/lt.json":12,"./languages/abbreviations/nl.json":13,"./languages/abbreviations/ru.json":14,"./languages/abbreviations/sl.json":15,"./languages/abbreviations/sv.json":16,"./languages/abbreviations/uk.json":17,"./languages/abbreviations/vi.json":18,"./languages/grammar/da.json":19,"./languages/grammar/fr.json":20,"./languages/grammar/hu.json":21,"./languages/grammar/ru.json":22,"./languages/translations/ar.json":23,"./languages/translations/da.json":24,"./languages/translations/de.json":25,"./languages/translations/en.json":26,"./languages/translations/eo.json":27,"./languages/translations/es-ES.json":28,"./languages/translations/es.json":29,"./languages/translations/fi.json":30,"./languages/translations/fr.json":31,"./languages/translations/he.json":32,"./languages/translations/hr.json":33,"./languages/translations/hu.json":34,"./languages/translations/id.json":35,"./languages/translations/it.json":36,"./languages/translations/ja.json":37,"./languages/translations/ko.json":38,"./languages/translations/my.json":39,"./languages/translations/nl.json":40,"./languages/translations/no.json":41,"./languages/translations/pl.json":42,"./languages/translations/pt-BR.json":43,"./languages/translations/pt-PT.json":44,"./languages/translations/ro.json":45,"./languages/translations/ru.json":46,"./languages/translations/sl.json":47,"./languages/translations/sv.json":48,"./languages/translations/tr.json":49,"./languages/translations/uk.json":50,"./languages/translations/vi.json":51,"./languages/translations/yo.json":52,"./languages/translations/zh-Hans.json":53}],3:[function(require,module,exports){
module.exports={
    "abbreviations": {
        "международен": "Межд",
        "старши": "Стрш",
...
module.exports={
    ...
    "v5": {
        "constants": {
            ...
            "lanes": {
                "xo": "Držite se desne strane",
                "ox": "Držite se lijeve strane",
                "xox": "Držite se sredine ceste",
                "oxo": "Držite se lijeve ili desne strane"
            }
        },
        "modes": {
            "ferry": {
                "default": "Uzmite trajekt",
                "name": "Uzmite trajekt {way_name}",
                "destination": "Uzmite trajekt prema {destination}"
            }
        },
        "phrase": {
            "two linked by distance": "{instruction_one}, zatim, za {distance}, {instruction_two}",
            "two linked": "{instruction_one}, zatim {instruction_two}",
            "one in distance": "Za {distance}, {instruction_one}",
            "name and ref": "{name} ({ref})",
            "exit with number": "izlaz {exit}"
        },
        "arrive": {
            "default": {
                "default": "Stigli ste na vaše {nth} odredište",
                "upcoming": "Stići ćete na vaše {nth} odredište",
                "short": "Stigli ste",
                "short-upcoming": "Stići ćete",
                "named": "Stigli ste na {waypoint_name}"
            },
            "left": {
                "default": "Stigli ste na vaše {nth} odredište s lijeve strane",
                "upcoming": "Stići ćete na vaše {nth} odredište s lijeve strane",
                "short": "Stigli ste",
                "short-upcoming": "Stići ćete",
                "named": "Stigli ste na {waypoint_name} s lijeve strane"
            },
            "right": {
                "default": "Stigli ste na vaše {nth} odredište s desne strane",
                "upcoming": "Stići ćete na vaše {nth} odredište s desne strane",
                "short": "Stigli ste",
                "short-upcoming": "Stići ćete",
                "named": "Stigli ste na {waypoint_name} s desne strane"
            },
            "sharp left": {
                "default": "Stigli ste na vaše {nth} odredište s lijeve strane",
                "upcoming": "Stići ćete na vaše {nth} odredište s lijeve strane",
            ...
            "straight": {
              "default": "Stigli ste na vaše {nth} odredište ravno naprijed",
              "upcoming": "Stići ćete na vaše {nth} odredište ravno naprijed",
              "short": "Stigli ste",
              "short-upcoming": "Stići ćete",
              "named": "Stigli ste na {waypoint_name} ravno naprijed"
            }
        },
        "continue": {
            "default": {
                "default": "Skrenite {modifier}",
                "name": "Skrenite {modifier} kako bi ostali na {way_name}",
                "destination": "Skrenite {modifier} prema {destination}",
                "exit": "Skrenite {modifier} prema {way_name}"
            },
            "straight": {
                "default": "Nastavite ravno",
                "name": "Nastavite ravno kako bi ostali na {way_name}",
                "destination": "Nastavite prema {destination}",
                "distance": "Nastavite ravno za {distance}",
                "namedistance": "Nastavite na {way_name} za {distance}"
            },
            "sharp left": {
                "default": "Skrenite ošto lijevo",
                "name": "Skrenite ošto lijevo kako bi ostali na {way_name}",
                "destination": "Skrenite oštro lijevo prema {destination}",
                "junction_name": "Skrenite oštro lijevo na {junction_name}"
            },
            "sharp right": {
                "default": "Skrenite ošto desno",
                "name": "Skrenite ošto desno kako bi ostali na {way_name}",
                "destination": "Skrenite oštro desno prema {destination}",
                "junction_name": "Skrenite oštro desno na {junction_name}"
            },
            "slight left": {
                "default": "Skrenite blago lijevo",
                "name": "Skrenite blago lijevo kako bi ostali na {way_name}",
                "destination": "Skrenite blago lijevo prema {destination}",
                "junction_name": "Skrenite blago lijevo na {junction_name}"
            },
            "slight right": {
                "default": "Skrenite blago desno",
                "name": "Skrenite blago desno kako bi ostali na {way_name}",
                "destination": "Skrenite blago desno prema {destination}",
                "junction_name": "Skrenite blago desno {junction_name}"
            },
            "uturn": {
                "default": "Okrenite se polukružno",
                "name": "Okrenite se polukružno i nastavite na {way_name}",
                "destination": "Okrenite se polukružno prema {destination}",
                "junction_name": "Okrenite se polukružno na {junction_name}"
            }
        },
        "depart": {
            "default": {
              "default": "Krenite na {direction}",
                "name": "Krenite na {direction} na {way_name}",
                "namedistance": "Krenite na {direction} na {way_name} za {distance}"
            }
        },
        "end of road": {
            "default": {
                "default": "Skrenite {modifier}",
                "name": "Skrenite {modifier} na {way_name}",
                "destination": "Skrenite {modifier} prema {destination}",
                "junction_name": "Skrenite {modifier} na {junction_name}"
            },
            "straight": {
                "default": "Nastavite ravno",
                "name": "Nastavite ravno na {way_name}",
                "destination": "Nastavite ravno prema {destination}",
                "junction_name": "Nastavite ravno na {junction_name}"
            },
            "uturn": {
                "default": "Okrenite se polukružno na kraju ceste",
                "name": "Okrenite se polukružno na {way_name} na kraju ceste",
                "destination": "Okrenite se polukružno prema {destination} na kraju ceste",
                "junction_name": "Okrenite se polukružno na {junction_name}"
            }
        },
        "fork": {
            "default": {
                "default": "Držite se {modifier} na račvanju",
                "name": "Držite se {modifier} na {way_name}",
                "destination": "Držite se {modifier} prema {destination}"
            },
            "slight left": {
                "default": "Držite se lijevo na račvanju",
                "name": "Držite se lijevo na {way_name}",
                "destination": "Držite se lijevo prema {destination}"
            },
            "slight right": {
              "default": "Držite se desno na račvanju",
              "name": "Držite se desno na {way_name}",
              "destination": "Držite se desno prema {destination}"
            },
            "sharp left": {
                "default": "Skrenite oštro lijevo na račvanju",
                "name": "Skrenite oštro lijevo na {way_name}",
                "destination": "Skrenite oštro lijevo prema {destination}"
            },
            "sharp right": {
                "default": "Skrenite oštro desno na račvanju",
                "name": "Skrenite oštro desno na {way_name}",
                "destination": "Skrenite oštro desno prema {destination}"
            },
            "uturn": {
                "default": "Okrenite se polukružno",
                "name": "Okrenite se polukružno na {way_name}",
                "destination": "Okrenite se polukružno prema {destination}"
            }
        },
        "merge": {
            "default": {
                "default": "Spojite se {modifier}",
                "name": "Spojite se {modifier} na {way_name}",
                "destination": "Spojite se {modifier} prema {destination}"
            },
            "straight": {
                "default": "Spojite se",
                "name": "Spojite se na {way_name}",
                "destination": "Spojite se prema {destination}"
            },
            "slight left": {
                "default": "Spojite se s lijeve strane",
                "name": "Spojite se s lijeve strane na {way_name}",
                "destination": "Spojite se s lijeve strane prema {destination}"
            },
            "slight right": {
                "default": "Spojite se s desne strane",
                "name": "Spojite se s desne strane na {way_name}",
                "destination": "Spojite se s desne strane prema {destination}"
            },
            "sharp left": {
                "default": "Spojite se s lijeve strane",
                "name": "Spojite se s lijeve strane na {way_name}",
        ...
        "new name": {
            "default": {
                "default": "Nastavite {modifier}",
                "name": "Nastavite {modifier} na {way_name}",
                "destination": "Nastavite {modifier} na {destination}"
            },
            "straight": {
                "default": "Nastavite ravno",
                "name": "Nastavite na {way_name}",
                "destination": "Nastavite prema {destination}"
            },
            "sharp left": {
                "default": "Skrenite oštro lijevo",
                "name": "Skrenite oštro lijevo na {way_name}",
                "destination": "Skrenite oštro lijevo prema {destination}"
            },
            "sharp right": {
                "default": "Skrenite oštro desno",
                "name": "Skrenite oštro desno na {way_name}",
                "destination": "Skrenite oštro desno prema {destination}"
            },
            "slight left": {
                "default": "Nastavite blago lijevo",
                "name": "Nastavite blago lijevo na {way_name}",
                "destination": "Nastavite blago lijevo prema {destination}"
            },
            "slight right": {
                "default": "Nastavite blago desno",
                "name": "Nastavite blago desno na {way_name}",
                "destination": "Nastavite blago desno prema {destination}"
            },
            "uturn": {
                "default": "Okrenite se polukružno",
                "name": "Okrenite se polukružno na {way_name}",
        ...
        "notification": {
            "default": {
                "default": "Nastavite {modifier}",
                "name": "nastavite{modifier} na {way_name}",
                "destination": "Nastavite {modifier} prema {destination}"
            },
            "uturn": {
                "default": "Okrenite se polukružno",
                "name": "Okrenite se polukružno na {way_name}",
        ...
        "off ramp": {
            "default": {
                "default": "Vozite do izlaza",
                "name": "Izađite na {way_name}",
                "destination": "Izađite na izlaz prema {destination}",
                "exit": "Izađite na izlaz {exit}",
                "exit_destination": "Izađite na izlaz {exit} prema {destination}"
            },
            "left": {
                "default": "Izađite na izlaz s lijeve strane",
                "name": "Izađite na izlaz s lijeve strane na {way_name}",
                "destination": "Izađite na izlaz s lijeve strane prema {destination}",
                "exit": "Izađite na izlaz {exit} s lijeve strane",
                "exit_destination": "Izađite na izlaz {exit} s lijeve stane prema {destination}"
            },
            "right": {
                "default": "Izađite na izlaz s desne strane",
                "name": "Izađite na izlaz s desne strane na {way_name}",
                "destination": "Izađite na izlaz s desne strane prema {destination}",
                "exit": "Izađite na izlaz {exit} s desne strane",
                "exit_destination": "Izađite na izlaz {exit} s desne stane prema {destination}"
            },
            "sharp left": {
                "default": "Izađite na izlaz s lijeve strane",
                "name": "Izađite na izlaz s lijeve strane na {way_name}",
        ...
        "on ramp": {
            "default": {
                "default": "Vozite do ulaza",
                "name": "Uđite na {way_name}",
                "destination": "Uđite na ulaz prema {destination}"
            },
            "left": {
                "default": "Uđite na ulaz s lijeve strane",
                "name": "Uđite na ulaz s lijeve strane na {way_name}",
                "destination": "Uđite na ulaz s lijeve strane prema {destination}"
            },
            "right": {
                "default": "Uđite na ulaz s desne strane",
                "name": "Uđite na ulaz s desne strane na {way_name}",
                "destination": "Uđite na ulaz s desne strane prema {destination}"
            },
            "sharp left": {
                "default": "Uđite na ulaz s lijeve strane",
                "name": "Uđite na ulaz s lijeve strane na {way_name}",
        ...
        "rotary": {
            "default": {
                "default": {
                    "default": "Uđite na kružni tok",
                    "name": "Uđite na kružni tok i Izađite na {way_name}",
                    "destination": "Uđite na kružni tok i izađite prema {destination}"
                },
                "name": {
                    "default": "Uđite na {rotary_name}",
                    "name": "Uđite na {rotary_name} i izađite na {way_name}",
                    "destination": "Uđite na {rotary_name} i izađite prema {destination}"
                },
                "exit": {
                    "default": "Uđite na kružni tok i izađite na {exit_number} izlaz",
                    "name": "Uđite na kružni tok i izađite na {exit_number} izlaz na {way_name}",
                    "destination": "Uđite na kružni tok i izađite {exit_number} izlaz prema {destination}"
                },
                "name_exit": {
                    "default": "Uđite na {rotary_name} i izađite na {exit_number} izlaz",
                    "name": "Uđite na {rotary_name} i izađite na {exit_number} izlaz na {way_name}",
                    "destination": "Uđite na {rotary_name} i izađite na {exit_number} izlaz prema {destination}"
                }
            }
        },
        "roundabout": {
            "default": {
                "exit": {
                    "default": "Uđite na kružni tok i izađite na {exit_number} izlaz",
                    "name": "Uđite na kružni tok i izađite na {exit_number} izlaz na {way_name}",
                    "destination": "Uđite na kružni tok i izađite na {exit_number} izlaz prema {destination}"
                },
                "default": {
                    "default": "Uđite na kružni tok",
                    "name": "Uđite na kružni tok i izađite na {way_name}",
                    "destination": "Uđite na kružni tok i izađite na izlaz prema {destination}"
                }
            }
        },
        "roundabout turn": {
            ...
            "left": {
                "default": "Skrenite lijevo",
                "name": "Skrenite lijevo na {way_name}",
                "destination": "Skrenite lijevo prema {destination}"
            },
            "right": {
                "default": "Skrenite desno",
                "name": "Skrenite desno na {way_name}",
                "destination": "Skrenite desno prema {destination}"
            },
            "straight": {
                "default": "Nastavite ravno",
                "name": "Nastavite ravno na {way_name}",
        ...
        "exit roundabout": {
            "default": {
                "default": "Izađite s kružnog toka",
                "name": "Izađite s kružnog toka na {way_name}",
                "destination": "Izađite s kružnog toka prema {destination}"
            }
        },
        "exit rotary": {
            "default": {
        ...
        "turn": {
            ...
            "left": {
                ...
                "name": "Skrenite lijevo na {way_name}",
                "destination": "Skrenite lijevo prema {destination}",
                "junction_name": "Skrenite lijevo na {junction_name}"
            },
            "right": {
                "default": "Skrenite desno",
                "name": "Skrenite desno na {way_name}",
                "destination": "Skrenite desno prema {destination}",
                "junction_name": "Skrenite desno na {junction_name}"
            },
            "straight": {
                "default": "Nastavite ravno",
                "name": "Nastavite ravno na {way_name}",
    ...
    "v5": {
        "constants": {
            ...
            "modifier": {
                "left": "ဘယ်ဘက်",
                "right": "ညာဘက်",
                "sharp left": "ဘယ်ဘက် ထောင့်ချိုး",
                "sharp right": "ညာဘက် ထောင့်ချိုး",
                "slight left": "ဘယ်ဘက် အနည်းငယ်",
                "slight right": "ညာဘက် အနည်းငယ်",
                "straight": "ဖြောင့်ဖြောင့်တန်းတန်း",
                "uturn": "ဂ-ကွေ့"
            },
            "lanes": {
                "xo": "ညာဘက်သို့ဆက်သွားပါ",
                "ox": "ဘယ်ဘက်သို့ဆက်သွားပါ",
                "xox": "အလယ်တွင်ဆက်နေပါ",
                "oxo": "ဘယ် သို့မဟုတ် ညာဘက်သို့ ဆက်သွားပါ"
            }
        },
        "modes": {
            "ferry": {
                "default": "ဖယ်ရီ စီးသွားပါ",
                "name": "{way_name}ကို ဖယ်ရီစီးသွားပါ",
                "destination": "{destination}ဆီသို့ ဖယ်ရီစီးသွားပါ"
            }
        },
        "phrase": {
            "two linked by distance": "{instruction_one}ပြီးနောက် {distance}အတွင်း {instruction_two}",
            "two linked": "{instruction_one}ပြီးနောက် {instruction_two}",
            "one in distance": "{distance}အတွင်း {instruction_one}",
            "name and ref": "{name}( {ref})",
            "exit with number": "{exit}မှထွက်ပါ"
        },
        "arrive": {
            "default": {
                "default": "{nth}သင် သွားလိုသော ခရီးပန်းတိုင်သို့ရောက်ရှိပြီ",
                "upcoming": "သင် သွားလိုသော {nth}ခရီးပန်းတိုင်သို့ရောက်လိမ့်မည်",
                "short": "သင်သွားလိုသော နေရာသို့ ရောက်ရှိပြီ",
                "short-upcoming": "သင်သွားလိုသော နေရာသို့ ရောက်လိမ့်မည်",
                "named": "သင် သည် {waypoint_name} မှာ ရောက်ရှိပြီ"
            },
            "left": {
                "default": "သင် သွားလိုသော {nth}ခရီးပန်းတိုင်သို့ဘယ်ဘက်တွင်ရောက်ရှိပြီ",
                "upcoming": "သင် သွားလိုသော {nth}ခရီးပန်းတိုင်သို့ဘယ်ဘက်တွင်ရောက်လိမ့်မည်",
                "short": "သင်သွားလိုသော နေရာသို့ ရောက်ရှိပြီ",
                "short-upcoming": "သင်သွားလိုသော နေရာသို့ ရောက်လိမ့်မည်",
                "named": "သင် သည် {waypoint_name}မှာဘယ်ဘက်ကွေ့ကာ ရောက်ရှိပြီ"
            },
            "right": {
                "default": "သင် သွားလိုသော {nth}ခရီးပန်းတိုင်သို့ ညာဘက်ကွေ့ကာ ရောက်ရှိပြီ",
                "upcoming": "သင် သွားလိုသော{nth} ခရီးပန်းတိုင်သို့ ညာဘက်ကွေ့ကာ ရောက်လိမ့်မည်",
                "short": "သင်သွားလိုသော နေရာသို့ ရောက်ရှိပြီ",
                "short-upcoming": "သင်သွားလိုသော နေရာသို့ ရောက်လိမ့်မည်",
                "named": "သင် သည် {waypoint_name} မှာညာဘက်ကွေ့ကာ ရောက်ရှိပြီ"
            },
            "sharp left": {
                "default": "သင် သွားလိုသော {nth}ခရီးပန်းတိုင်သို့ဘယ်ဘက်တွင်ရောက်ရှိပြီ",
                "upcoming": "သင် သွားလိုသော {nth}ခရီးပန်းတိုင်သို့ဘယ်ဘက်တွင်ရောက်ရှိပြီ",
                "short": "သင်သွားလိုသော နေရာသို့ ရောက်ရှိပြီ",
                "short-upcoming": "သင်သွားလိုသော နေရာသို့ ရောက်လိမ့်မည်",
                "named": "သင် သည် {waypoint_name}မှာဘယ်ဘက်ကွေ့ကာ ရောက်ရှိပြီ"
            },
            ...
            "straight": {
                "default": "သင် သွားလိုသော {nth}ခရီးပန်းတိုင်သို့တည့်တည့်သွားကာရာက်ရှိပြီ",
                "upcoming": "သင် သွားလိုသော {nth}ခရီးပန်းတိုင်သို့တည့်တည့်သွားကာရာက်ရှိမည်",
                "short": "သင်သွားလိုသော နေရာသို့ ရောက်ရှိပြီ",
                "short-upcoming": "သင်သွားလိုသော နေရာသို့ ရောက်လိမ့်မည်",
                "named": "သင် သည် {waypoint_name}မှာတည့်တည့်သွားကာ ရောက်ရှိပြီ"
            }
        },
        "continue": {
            "default": {
                "default": "{modifier}ကိုလှည့်ပါ",
                "name": "{way_name}​ပေါ်တွင်နေရန် {modifier}ကိုလှည့်ပါ",
                "destination": "{destination}ဆီသို့ {modifier}ကို လှည့်ပါ",
                "exit": "{way_name}​ပေါ်သို့ {modifier}ကိုလှည့်ပါ"
            },
            "straight": {
                "default": "ဖြောင့်ဖြောင့်တန်းတန်း ဆက်သွားပါ",
                "name": "{way_name}​ပေါ်တွင်နေရန်တည်တည့်ဆက်သွာပါ",
                "destination": "{destination}ဆီသို့ဆက်သွားပါ",
                "distance": "{distance}လောက် တည့်တည့် ဆက်သွားပါ",
                "namedistance": "{way_name}ပေါ်တွင်{distance}လောက်ဆက်သွားပါ"
            },
            "sharp left": {
        ...
        "depart": {
            "default": {
                "default": "{direction}သို့ ဦးတည်ပါ",
                "name": "{direction}ကို {way_name}အပေါ်တွင် ဦးတည်ပါ",
                "namedistance": "{direction}ကို {way_name}အပေါ်တွင်{distance}လောက် ဦးတည်ဆက်သွားပါ"
            }
        },
        "end of road": {
            "default": {
        ...
        "fork": {
            "default": {
                "default": "လမ်းဆုံလမ်းခွတွင် {modifier}ကိုဆက်သွားပါ",
                "name": "{way_name}​ပေါ်သို့ {modifier}ကိုဆက်သွားပါ",
                "destination": "{destination}ဆီသို့ {modifier}ကို ဆက်သွားပါ"
            },
            "slight left": {
                "default": "လမ်းဆုံလမ်းခွတွင်ဘယ်ဘက်ကိုဆက်သွားပါ",
                "name": "{way_name}​ပေါ်သို့ဘယ်ဘက်ကိုဆက်သွားပါ",
                "destination": "{destination}ဆီသို့ဘယ်ဘက်ကို ဆက်သွားပါ"
            },
            "slight right": {
                "default": "လမ်းဆုံလမ်းခွတွင်ညာဘက်ကိုဆက်သွားပါ",
                "name": "{way_name}​ပေါ်သို့ညာဘက်ကိုဆက်သွားပါ",
                "destination": "{destination}ဆီသို့ညာဘက်ကို ဆက်သွားပါ"
            },
            "sharp left": {
                "default": "လမ်းဆုံလမ်းခွတွင်ဘယ်ဘက်ထောင့်ချိုးကိုသွားပါ",
                "name": "{way_name}ပေါ်တွင်နေရန် ဘယ်ဘက်ထောင့်ချိုးယူပါ",
                "destination": "{destination}ဆီသို့ဘယ်ဘက်ထောင့်ချိုး သွားပါ"
            },
            "sharp right": {
                "default": "လမ်းဆုံလမ်းခွတွင်ညာဘက်ထောင့်ချိုးကိုသွားပါ",
                "name": "{way_name}ပေါ်သို့ ညာဘက်ထောင့်ချိုးယူပါ",
                "destination": "{destination}ဆီသို့ညာဘက်ထောင့်ချိုး သွားပါ"
            },
            "uturn": {
                "default": "ဂ-ကွေ့ ကွေ့ပါ",
                "name": "{way_name}သို့ဂ-ကွေ့ကွေ့ပါ",
                "destination": "{destination}ဆီသို့ ဂကွေ့ချိုးကွေ့ပါ"
            }
        },
        "merge": {
            "default": {
                "default": "{modifier}ကိုလာရောက်ပေါင်းဆုံပါ",
                "name": "{way_name}​ပေါ်သို့ {modifier}ကိုလာရောက်ပေါင်းဆုံပါ",
                "destination": "{destination}ဆီသို့ {modifier}ကို လာရောက်ပေါင်းဆုံပါ"
            },
            "straight": {
                "default": "လာရောက်ပေါင်းဆုံပါ",
                "name": "{way_name}​ပေါ်သို့လာရောက်ပေါင်းဆုံပါ",
                "destination": "{destination}ဆီသို့ လာရောက်ပေါင်းဆုံပါ"
            },
            "slight left": {
                "default": "ဘယ်ဘက်သို့လာရောက်ပေါင်းဆုံပါ",
                "name": "{way_name}​ပေါ်သို့ဘယ်ဘက်ကိုလာရောက်ပေါင်းဆုံပါ",
                "destination": "{destination}ဆီသို့ဘယ်ဘက်ကို လာရောက်ပေါင်းဆုံပါ"
            },
            "slight right": {
                "default": "ညာဘက်သို့လာရောက်ပေါင်းဆုံပါ",
                "name": "{way_name}​ပေါ်သို့ညာဘက်ကိုလာရောက်ပေါင်းဆုံပါ",
                "destination": "{destination}ဆီသို့ညာဘက်ကို လာရောက်ပေါင်းဆုံပါ"
            },
            "sharp left": {
                "default": "ဘယ်ဘက်သို့လာရောက်ပေါင်းဆုံပါ",
                "name": "{way_name}​ပေါ်သို့ဘယ်ဘက်ကိုလာရောက်ပေါင်းဆုံပါ",
            ...
            "uturn": {
                "default": "ဂ-ကွေ့ ကွေ့ပါ",
                "name": "{way_name}လမ်းဘက်သို့ ဂ-ကွေ့ ကွေ့ပါ ",
                "destination": "{destination}ဆီသို့ ဂကွေ့ချိုးကွေ့ပါ"
            }
        },
        "new name": {
            "default": {
                "default": "{modifier}ကိုဆက်သွားပါ",
                "name": "{way_name}​ပေါ်သို့ {modifier}ကိုဆက်သွားပါ",
                "destination": "{destination}ဆီသို့ {modifier}ကို ဆက်သွားပါ"
            },
            "straight": {
                "default": "ဖြောင့်ဖြောင့်တန်းတန်း ဆက်သွားပါ",
                "name": "{way_name}ပေါ်သို့ဆက်သွားပါ",
                "destination": "{destination}ဆီသို့ဆက်သွားပါ"
            },
            "sharp left": {
                "default": "ဘယ်ဘက်ထောင့်ချိုးယူပါ",
                "name": "{way_name}ပေါ်တွင်နေရန် ဘယ်ဘက်ထောင့်ချိုးယူပါ",
                "destination": "{destination}ဆီသို့ဘယ်ဘက်ထောင့်ချိုး သွားပါ"
            },
            "sharp right": {
                "default": "ညာဘက် ထောင့်ချိုးယူပါ",
                "name": "{way_name}ပေါ်သို့ ညာဘက်ထောင့်ချိုးယူပါ",
                "destination": "{destination}ဆီသို့ညာဘက်ထောင့်ချိုး သွားပါ"
            },
            "slight left": {
                "default": "ဘယ်ဘက် အနည်းငယ်ဆက်သွားပါ",
                "name": "{way_name}​ပေါ်သို့ဘယ်ဘက် အနည်းငယ်ဆက်သွားပါ",
                "destination": "{destination}ဆီသို့ဘယ်ဘက်အနည်းငယ်ဆက်သွားပါ"
            },
            "slight right": {
                "default": "ညာဘက် အနည်းငယ်ဆက်သွားပါ",
                "name": "{way_name}​ပေါ်သို့ညာဘက် အနည်းငယ်ဆက်သွားပါ",
                "destination": "{destination}ဆီသို့ညာဘက်အနည်းငယ်ဆက်သွားပါ"
            },
            "uturn": {
                "default": "ဂ-ကွေ့ ကွေ့ပါ",
                "name": "{way_name}လမ်းဘက်သို့ ဂ-ကွေ့ ကွေ့ပါ",
        ...
        "off ramp": {
            "default": {
                "default": "ချဉ်းကပ်လမ်းကိုယူပါ",
                "name": "{way_name}ပေါ်သို့ချဉ်းကပ်လမ်းကိုယူပါ",
                "destination": "{destination}ဆီသို့ ချဉ်းကပ်လမ်းကိုယူပါ",
                "exit": "{exit}ကို ယူပါ",
                "exit_destination": "{destination}ဆီသို့ {exit} ကိုယူပါ"
            },
            "left": {
                "default": "ဘယ်ဘက်သို့ချဉ်းကပ်လမ်းကိုယူပါ",
                "name": "{way_name}ပေါ်သို့ဘယ်ဘက် ပေါ်တွင်ချဉ်းကပ်လမ်းကိုယူပါ",
                "destination": "{destination}ဆီသို့ ဘယ်ဘက်ပေါ်တွင်ချဉ်းကပ်လမ်းကိုယူပါ",
                "exit": "ဘယ်ဘက်တွင်{exit}ကို ယူပါ",
                "exit_destination": "{destination}ဆီသို့ဘယ်ဘက်မှ {exit} ကိုယူပါ"
            },
            "right": {
                "default": "ညာဘက်သို့ချဉ်းကပ်လမ်းကိုယူပါ",
                "name": "{way_name}ပေါ်သို့ညာဘက် ပေါ်တွင်ချဉ်းကပ်လမ်းကိုယူပါ",
                "destination": "{destination}ဆီသို့ ညာဘက်ပေါ်တွင်ချဉ်းကပ်လမ်းကိုယူပါ",
                "exit": "ညာဘက်တွင်{exit}ကို ယူပါ",
                "exit_destination": "{destination}ဆီသို့ညာဘက်မှ {exit} ကိုယူပါ"
            },
            "sharp left": {
                "default": "ဘယ်ဘက်သို့ချဉ်းကပ်လမ်းကိုယူပါ",
                "name": "{way_name}ပေါ်သို့ဘယ်ဘက် ပေါ်တွင်ချဉ်းကပ်လမ်းကိုယူပါ",
        ...
        "rotary": {
            "default": {
                "default": {
                    "default": "အဝိုင်းပတ်သို့ဝင်ပါ",
                    "name": "{way_name}ပေါ်သို့အဝိုင်းပတ်လမ်းမှထွက်ပါ",
                    "destination": "{destination}ပေါ်သို့အဝိုင်းပတ်လမ်းမှထွက်ပါ"
                },
                "name": {
                    "default": "{rotary_name}သို့ဝင်ပါ",
                    "name": "{rotary_name}အဝိုင်းပတ်ဝင်ပြီး{way_name}ပေါ်သို့ထွက်ပါ",
                    "destination": "{rotary_name}အဝိုင်းပတ်ဝင်ပြီး{destination}ဆီသို့ထွက်ပါ"
                },
                "exit": {
                    "default": "အဝိုင်းပတ်ဝင်ပြီး{exit_number}ကိုယူကာပြန်ထွက်ပါ",
                    "name": "အဝိုင်းပတ်သို့ဝင်ပြီး{exit_number}ကိုယူကာ{way_name}ပေါ်သို့ထွက်ပါ",
                    "destination": "အဝိုင်းပတ်ဝင်ပြီး{exit_number}ကိုယူကာ{destination}ဆီသို့ထွက်ပါ"
                },
                "name_exit": {
                    "default": "{rotary_name}ကိုဝင်ပြီး {exit_number}ကိုယူကာထွက်ပါ",
                    "name": "{rotary_name}ကိုဝင်ပြီး{exit_number}ကိုယူကာ{way_name}ပေါ်သို့ထွက်ပါ",
                    "destination": "{rotary_name}ဝင်ပြီး{exit_number}ကိုယူကာ{destination}ဆီသို့ထွက်ပါ"
                }
            }
        },
        "roundabout": {
            "default": {
                "exit": {
                    "default": "{exit_number}ပေါ်သို့အဝိုင်းပတ်လမ်းမှထွက်ပါ",
                    "name": "အဝိုင်းပတ်ဝင်ပြီး{exit_number}ကိုယူကာ{way_name}ပေါ်သို့ထွက်ပါ",
                    "destination": "အဝိုင်းပတ်ဝင်ပြီး{exit_number}ကိုယူကာ{destination}ဆီသို့ထွက်ပါ"
                },
                "default": {
                    "default": "အဝိုင်းပတ်ဝင်ပါ",
                    "name": "{way_name}ပေါ်သို့အဝိုင်းပတ်လမ်းမှထွက်ပါ",
                    "destination": "{destination}ပေါ်သို့အဝိုင်းပတ်လမ်းမှထွက်ပါ"
                }
            }
        ...
        "roundabout turn": {
            ...
            "left": {
                ...
                "name": "{way_name}ပေါ်သို့ဘယ်ဘက်ကိုဆက်သွားပါ",
                "destination": "{destination}ဆီသို့ဘယ်ဘက်မှ ကွေ့ပါ"
            },
            "right": {
        ...
        "exit roundabout": {
            "default": {
                "default": "အဝိုင်းပတ်လမ်းမှထွက်ပါ",
                "name": "{way_name}ပေါ်သို့အဝိုင်းပတ်လမ်းမှထွက်ပါ",
                "destination": "ဦးတည်အဝိုင်းပတ်လမ်းမှထွက်ပါ{destination}"
            }
        },
        "exit rotary": {
            "default": {
                "default": "အဝိုင်းပတ်လမ်းမှထွက်ပါဦးတည်အဝိုင်းပတ်လမ်းမှထွက်ပါ",
                "name": "{way_name}ပေါ်သို့အဝိုင်းပတ်လမ်းမှထွက်ပါ",
                "destination": "ဦးတည်အဝိုင်းပတ်လမ်းမှထွက်ပါ{destination}"
            }
        },
    ...
    "v5": {
        "constants": {
            ...
            "direction": {
                ...
                "northeast": "Ariwa",
                "east": "õrùn",
                "southeast": "Guusu ila oorun",
                "south": "guusu",
                "southwest": "Southwest",
                "west": "oorun",
                "northwest": "ariwa-oorun"
            },
            "modifier": {
                "left": "apa osi",
                "right": "ọtun",
                "sharp left": "didasilẹ",
                "sharp right": "didasilẹ ọtun",
                "slight left": "diẹ osi",
                "slight right": "diẹ ọtun",
                "straight": "Taara",
                "uturn": "U-tan"
            },
            "lanes": {
                ...
                "ox": "pa osi",
                "xox": "Jeki ni arin",
                "oxo": "Jeki osi tabi ọtun"
            }
        },
        "modes": {
            "ferry": {
                "default": "Gba ọkọ oju-omi naa",
                "name": "Gba ọkọ oju-omi naa {way_name}",
                "destination": "Mu ọna ọkọ lọ si ọna {destination}"
            }
        },
        "phrase": {
            "two linked by distance": "{instruction_one}, lẹhinna, ni {distance} {instruction_two}",
            "two linked": "{instruction_one}, lẹhinna {instruction_two}",
            "one in distance": "Ni {distance}, {instruction_one}",
            "name and ref": "{name} ({ref})",
            "exit with number": "Jade {exit}"
        },
        "arrive": {
            "default": {
                "default": "O ti de ọdọ rẹ {nth} ibi ti nlo",
                "upcoming": "O yoo de ọdọ rẹ {nth} ibi ti nlo",
                "short": "O ti de",
                "short-upcoming": "Iwọ yoo de",
                "named": "O ti de {waypoint_name}"
            },
            "left": {
                "default": "O ti de ọdọ rẹ {nth} nlo, lori osi",
                "upcoming": "O yoo de ọdọ rẹ {nth} nlo, lori osi",
                "short": "O ti de",
                "short-upcoming": "Iwọ yoo de",
                "named": "O ti de {waypoint_name}, lori osi"
            },
            "right": {
                "default": "O ti de ọdọ rẹ {nth} nlo, lori ọtun",
                "upcoming": "O yoo de ọdọ ọ {nth} nlo, lori ọtun",
                "short": "O ti de",
                "short-upcoming": "Iwọ yoo de",
                "named": "O ti de {waypoint_name}, ni apa otun"
            },
            "sharp left": {
                "default": "O ti de ọdọ rẹ {nth} nlo, lori osi",
                "upcoming": "O yoo de ọdọ rẹ {nth} nlo, lori lef",
                "short": "O ti de",
                "short-upcoming": "Iwọ yoo de",
                "named": "O ti de {waypoint_name}, lori osi"
            },
            ...
            "straight": {
                "default": "O ti de ọdọ rẹ {nth} nlo, ni gígùn niwaju",
                "upcoming": "O yoo de ọdọ rẹ {nth} nlo, ni gígùn niwaju",
                "short": "O ti de",
                "short-upcoming": "Iwọ yoo de",
                "named": "O ti de {waypoint_name}, ni gígùn niwaju"
            }
        },
        "continue": {
            "default": {
                "default": "Tan-an {modifier}",
                "name": "Tan-an {modifier} lati duro si {way_name}",
                "destination": "Tan-an {modifier} si ọna {destination}",
                "exit": "Tan-an {modifier} pẹlẹpẹlẹ {way_name}"
            },
            "straight": {
                "default": "Tẹsiwaju ni gígùn",
                "name": "Tesiwaju ni gígùn lati duro si {way_name}",
                "destination": "Tesiwaju si ọna {destination}",
                "distance": "Tesiwaju tẹsiwaju fun {distance}",
                "namedistance": "Tesiwaju {way_name} fun {distance}"
            },
            "sharp left": {
        ...
        "depart": {
            "default": {
                "default": "Ori {direction}",
                "name": "Ori {direction} lori {way_name}",
                "namedistance": "Ori {direction} lori {way_name} fun {distance}"
            }
        },
        "end of road": {
            "default": {
        ...
        "fork": {
            "default": {
                "default": "Jeki {modifier} ni orita",
                "name": "Jeki {modifier} pẹlẹpẹlẹ {way_name}",
                "destination": "Jeki {modifier} si ọna {destination}"
            },
            "slight left": {
                "default": "Jeki osi ni orita",
                "name": "Jeki pẹlẹpẹlẹ osi {way_name}",
                "destination": "Jeki osi si ọna {destination}"
            },
            "slight right": {
                "default": "Jeki ọtun ni orita",
                "name": "Jeki ọtun pẹlẹpẹlẹ {way_name}",
                "destination": "Pa ọtun si ọna {destination}"
            },
            "sharp left": {
                "default": "Mu apa osi ni orita",
                "name": "Mu pẹlẹpẹlẹ sisun ti osi {way_name}",
                "destination": "Mu apa osi to ni ọna {destination}"
            },
            "sharp right": {
                "default": "Mu didasilẹ to dara ni orita",
                "name": "Mu pẹlẹsẹ to dara julọ {way_name}",
                "destination": "Mu ọna didasilẹ taara si ọna {destination}"
            },
            "uturn": {
                "default": "Ṣe ayipada U",
                "name": "Ṣe U-tan pẹlẹpẹlẹ {way_name}",
                "destination": "Ṣe ọna U-ọna si ọna {destination}"
            }
        },
        "merge": {
            "default": {
                "default": "Dapọ {modifier}",
                "name": "Dapọ {modifier} pẹlẹpẹlẹ {way_name}",
                "destination": "Dapọ {modifier} si ọna {destination}"
            },
            "straight": {
                "default": "Dapọ",
                "name": "Darapọ pẹlẹpẹlẹ {way_name}",
                "destination": "Darapọ si ọna {destination}"
            },
            "slight left": {
                "default": "Dapọ osi",
                "name": "Dapọ pẹlẹpẹlẹ osi {way_name}",
                "destination": "Dapọ si ọna osi si ọna {destination}"
            },
            "slight right": {
                "default": "Dapọ ọtun",
                "name": "Darapọ mọ pẹlẹpẹlẹ {way_name}",
                "destination": "Darapọ ọtun si ọna {destination}"
            },
            "sharp left": {
                "default": "Dapọ osi",
                "name": "Dapọ pẹlẹpẹlẹ osi {way_name}",
        ...
        "new name": {
            "default": {
                "default": "Tesiwaju {modifier}",
                "name": "Tesiwaju {modifier} pẹlẹpẹlẹ {way_name}",
                "destination": "Tesiwaju {modifier} si ọna {destination}"
            },
            "straight": {
                "default": "Tẹsiwaju ni gígùn",
                "name": "Tẹsiwaju pẹlẹpẹlẹ {way_name}",
                "destination": "Tesiwaju si ọna {destination}"
            },
            "sharp left": {
                "default": "Mu apa osi to ni didasilẹ",
                "name": "Mu pẹlẹpẹlẹ sisun ti osi {way_name}",
                "destination": "Mu apa osi to ni ọna {destination}"
            },
            "sharp right": {
                "default": "Mu ẹtọ to dara julọ",
                "name": "Mu pẹlẹsẹ to dara julọ {way_name}",
                "destination": "Mu ọna didasilẹ taara si ọna {destination}"
            },
            "slight left": {
                "default": "Tẹsiwaju ni apa osi",
                "name": "Tesiwaju die-die silẹ pẹlẹpẹlẹ {way_name}",
                "destination": "Tẹsiwaju ni apa osi si ọna {destination}"
            },
            "slight right": {
                "default": "Tẹsiwaju die-die ọtun",
                "name": "Tesiwaju die-die ọtun pẹlẹpẹlẹ {way_name}",
                "destination": "Tẹsiwaju die-die si ọna ọtun {destination}"
            },
            "uturn": {
                "default": "Ṣe ayipada U",
                "name": "Ṣe U-tan pẹlẹpẹlẹ {way_name}",
        ...
        "off ramp": {
            "default": {
                "default": "Ya awọn ibọn",
                "name": "Mu awọn rampan si pẹlẹpẹlẹ {way_name}",
                "destination": "Mu awọn rampu si ọna {destination}",
                "exit": "Mu jade kuro {exit}",
                "exit_destination": "Mu jade kuro {exit} si ọna {destination}"
            },
            "left": {
                "default": "Gba rampu ni apa osi",
                "name": "Gba awọn ibọn ni apa osi pẹlẹpẹlẹ {way_name}",
                "destination": "Mu awọn rampu ni apa osi si ọna {destination}",
                "exit": "Mu jade kuro {exit} lori osi",
                "exit_destination": "Mu jade kuro {exit} ni apa osi si ọna {destination}"
            },
            "right": {
                "default": "Gba awọn rampu ni apa ọtun",
                "name": "Mu awọn rampu lori ọtun pẹlẹpẹlẹ {way_name}",
                "destination": "Gba eefin naa ni apa ọtun si ọna {destination}",
                "exit": "Mu jade kuro {exit} ni apa otun",
                "exit_destination": "Mu jade kuro {exit} lori ọtun si ọna {destination}"
            },
            "sharp left": {
                "default": "Gba rampu ni apa osi",
                "name": "Gba awọn ibọn ni apa osi pẹlẹpẹlẹ {way_name}",
        ...
        "rotary": {
            "default": {
                "default": {
                    "default": "Tẹ ẹkun ijabọ",
                    "name": "Tẹ atẹgun iṣowo ati jade ni pẹlẹpẹlẹ {way_name}",
                    "destination": "Tẹ ọna iṣọwo ati jade lọ si ọna {destination}"
                },
                "name": {
                    "default": "Tẹ {rotary_name}",
                    "name": "Tẹ {rotary_name} ati jade ni pẹlẹpẹlẹ {way_name}",
                    "destination": "Tẹ {rotary_name} ati jade lọ si ọna {destination}"
                },
                "exit": {
                    "default": "Tẹ ẹkun ijabọ ati ki o ya {exit_number} jade",
                    "name": "Tẹ ẹkun ijabọ ati ki o ya {exit_number} jade pẹlẹpẹlẹ {way_name}",
                    "destination": "Tẹ ẹkun ijabọ ati ki o ya {exit_number} jade si ọna {destination}"
                },
                "name_exit": {
                    "default": "Tẹ {rotary_name} ki o si ya {exit_number} jade",
                    "name": "Tẹ {rotary_name} ki o si ya {exit_number} jade pẹlẹpẹlẹ {way_name}",
                    "destination": "Tẹ {rotary_name} ki o si ya {exit_number} jade si ọna {destination}"
                }
            }
        },
        "roundabout": {
        ...
        "exit roundabout": {
            "default": {
                "default": "Jade ni ọna iṣowo",
                "name": "Jade ni ọna iṣakoso pẹlẹpẹlẹ {way_name}",
                "destination": "Jade ọna opopona si ọna {destination}"
            }
        },
        "exit rotary": {
            "default": {
