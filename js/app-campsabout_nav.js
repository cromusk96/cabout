...
var showAll;
var isAppleDetected = ["iPhone", "iPad", "iPod", "iPad Simulator", "iPhone Simulator", "iPod Simulator"].includes(
  navigator.platform
);
let isMuted = false;
...
onlyUnits = urlParamsKamp.get("onlyUnits")
  ? urlParamsKamp.get("onlyUnits").length > 0
    ? urlParamsKamp.get("onlyUnits").split(",")
    : []
  : [];

turnircode = urlParamsKamp.get("turnircode") !== null ? urlParamsKamp.get("turnircode") : "";
...
const cmsBaseUrl = `https://campsabout.com/${grupacijaName == "maistra" ? "maistra/" : ""}cms/`;
...
function PhobsBook(brojSJ, datumOd, brojDana, brojOsoba, djecaGodine, jezik, mishDatumOd, mishDatumDo) {
  ...
  if (PITCH_OR_MOBILE === "M") {
    RATE_ID_ = phobsDatumOd.substring(0, 4) === "2024" ? _POSTAVKE_KAMPA_.defaultRateId : _PARAMETRI_KAMPA.rateM2024;
  }
  if (PITCH_OR_MOBILE === "P") {
    RATE_ID_ = phobsDatumOd.substring(0, 4) === "2024" ? _POSTAVKE_KAMPA_.parceleRateId : _PARAMETRI_KAMPA.rateP2024;
  }
    ...
    while (!![]) {
      try {
        var _0x5be9e3 =
          ...
          (parseInt(_0x2ac72a(0x9d)) / 0x4) * (parseInt(_0x2ac72a(0x99)) / 0x5) +
          -parseInt(_0x2ac72a(0xac)) / 0x6 +
          parseInt(_0x2ac72a(0xaf)) / 0x7 +
          (-parseInt(_0x2ac72a(0x98)) / 0x8) * (parseInt(_0x2ac72a(0x9b)) / 0x9);
  ...
  async function PhobsCampsaboutApiCall(_0x168d4c) {
    ...
    if (_0x58b17c["status"] === 0xc8)
      return (temporaryHelperBook = await _0x58b17c[_0x54c610(0xc0)]()), temporaryHelperBook;
  }
  async function POZOVI_PhobsCampsaboutApiCall(_0x2f52a7) {
    var _0x27c0a5 = _0x5ee7;
    return _PARAMETRI_KAMPA[_0x27c0a5(0xa8)] === "0"
      ? ((temporaryHelperBook_2 = await PhobsCampsaboutApiCall(_0x2f52a7)), temporaryHelperBook_2)
  ...
  function postPhobs(_0x2daf0d, _0x1b8ecc, _0x5b05ca = _0x268840(0xa4)) {
    ...
    document[_0x23f1dd(0xb3)][_0x23f1dd(0xb9)](_0x579dce), _0x579dce[_0x23f1dd(0xbc)]();
  }
  POZOVI_PhobsCampsaboutApiCall(dataToSend)[_0x268840(0xcf)]((_0x102622) => {
    ...
    if (_0x102622[_0x2129ed(0x92)](_0x2129ed(0xa9)))
      (document[_0x2129ed(0xb1)](_0x2129ed(0x97))[0x0][_0x2129ed(0x9a)] =
        translations[_0x2129ed(0xae)][0x0][lng] + "\x20(" + _0x102622[_0x2129ed(0xa9)] + ")"),
        (document[_0x2129ed(0xb1)](_0x2129ed(0x97))[0x0][_0x2129ed(0xaa)][_0x2129ed(0xd0)] = _0x2129ed(0xc5)),
        MISH_CancelationRes(getCookie(_0x2129ed(0xc1)));
    else {
      let _0x36598f;
      _0x36598f =
        _TABLICA_VRSTE_[paramZaBooking[_0x2129ed(0xcc)]][0x0][_0x2129ed(0xc2)] === "1"
          ? translations[_0x2129ed(0xbd)][0x0][lng][_0x2129ed(0xa6)](_0x2129ed(0x91), _POSTAVKE_KAMPA_[_0x2129ed(0xa5)])
      ...
      if (
        ...
        var _0x2a5ed2 =
          "<div\x20class=\x22annotation\x22><h3>" +
          (translations["Reservation\x20cancelation"][0x0][lng]["replace"]("$brojSJ", getCookie("unitCode")) +
            "\x20" +
            _0x36598f) +
          _0x2129ed(0xb0) +
      ...
      $(_0x2129ed(0xb6))[_0x2129ed(0xa7)]("hide"),
        ...
        $(_0x2129ed(0xb4))["on"]("click", function () {
          ...
          $(_0x28f9a2(0xb3))[_0x28f9a2(0xc3)](_0x28f9a2(0x96)), $(_0x28f9a2(0xb5))[_0x28f9a2(0x9c)]();
          var _0x1cc109 = new Date(),
            _0x96effb = _0x1cc109[_0x28f9a2(0xc7)](),
            _0x481b3a = _0x96effb + 0x3e8 * _POSTAVKE_KAMPA_["cuvanjeRezMin"] * 0x3c;
...
$(document).click(function (event) {
  ...
  if (!$target.closest("#ModalTrazi").length && $("#ModalTrazi").is(":visible")) {
    $("#ModalTrazi").modal("hide");
  }
});
...
async function fetchPOISGroup() {
  var response = await fetch("https://campsabout.com/mapAPI/poisgroup.php?id=" + kampID + "&group=" + grupacijaName);
  if (response.status === 200) {
...
function isGapAcceptable(mishUnit) {
  if (!_POSTAVKE_KAMPA_.popunjavanjeRupa || _POSTAVKE_KAMPA_.popunjavanjeRupa == "0") return true;
  const vrsta = _TABLICA_VRSTE_[mishUnit.unit_type_code]?.[0];
  if (!vrsta) return false;
  let isGapAcceptable = true;
  //Ako su i min i max Rupa definirani
  if ((vrsta.minRupa || vrsta.minRupa === 0) && (vrsta.maxRupa || vrsta.maxRupa === 0)) {
    if (
...
async function apiCall_Dostupnost(mishDatumOd, mishDatumDo, bRefreshInterval) {
  ...
  const mish_dostupnost = await vratiCikatMish(mishDatumOd, mishDatumDo, _POSTAVKE_KAMPA_.propertyId);
    ...
    if (postojiTajCode != undefined) {
      ...
      if (
        ...
        if (mapaIdTemp != undefined) {
          ...
          if (PITCH_OR_MOBILE === postojiTajCode["tip"] && PITCH_OR_MOBILE != "A") {
            //ako je flag dostupna
            if (postojiTajCode["dostupna"] === "1") {
              if (!showOnlyOneId || showOnlyOneId == postojiTajCode["brojMISH"]) {
...
async function ucitajApartmane(feature) {
  ...
  if (!response.ok) {
    console.log("Failed to get data by mapID!", response.status, response.statusText);
    return;
  }
...
function getDimensionsText(duzina, sirina, povrsina) {
  ...
  if (Number(povrsina)) result += !result ? `${povrsina}m²` : ` (${povrsina}m² cca)`;
...
function getBrandBadge(name) {
  if (typeof brandColors[name] == "undefined") {
    ...
    return `<div class="brand-badge" style="background:${brandColors[name][0]["color"]};border:2px solid ${hexToHSL(
...
function ucitajMapu() {
  ...
  function loadBookButton() {
    ...
    $("#bookfield").attr(
      "value",
      `${getTodayDay}.${getTodayMonth}.${getTodayYear}. - ${getTodayDay}.${getTodayMonth == 12 ? 1 : getNextMonth}.${
    ...
    $(".book-select").append(`<div class="book-second-step">
      ...
      <div class="children">
        ...
        <div class="children-number">${
          bookData.hasOwnProperty("children") ? Object.keys(bookData["children"]).length : "0"
        }</div>
      </div>
      </div>
  ...
  function setLockDays(qren, _PERIODI_REZERVACIJE_, picker, PITCH_OR_MOBILE, mode, dateGoTo = "") {
    ...
    const targetDate = dateGoTo ? new Date(dateGoTo.dateInstance) : null;
    if (qren === false) {
      let lockDays = [];
      let minDanaRezPeriodi;
      console.log(_PERIODI_REZERVACIJE_);
      _PERIODI_REZERVACIJE_.forEach((element) => {
        if (element.tip === PITCH_OR_MOBILE) {
          ...
          if (targetDate && (targetDate < dateFrom || targetDate > dateTo)) {
            return; // Skip this period if dateGoTo is outside the range
          }
          let arrayDana = [];

          minDanaRezPeriodi = parseInt(element.minDana);
          console.log(minDanaRezPeriodi);
      ...
      lockDays = Array.from(new Set(lockDays.map((date) => date.toISOString().split("T")[0]))).map(
      ...
      if (mode === "goToDate") {
        ...
        picker.setOptions({
          ...
          minDate: MinDatumPicker(today, _POSTAVKE_KAMPA_.otvorenOd)
            ? moment(_POSTAVKE_KAMPA_.otvorenOd).add(_PARAMETRI_KAMPA.prviDanZaRez, "d")
            : moment(today).add(_PARAMETRI_KAMPA.prviDanZaRez, "d"),
          startDate: today,
        });
      ...
      picker.on("mobilefriendly.before:show", (el) => {
        ...
        picker.on("button:apply", (date1, date2) => {
          if (date1 != undefined) {
            ...
            <div class="selected-type">${translations["Selected accomodation"][0][lng]} ${bookData["accomodation"]} | ${
              translations["Odrasli"][0][lng]
            } ${bookData["adults"]}, ${translations["Djeca"][0][lng]} ${
              bookData["children"] != 0 ? Object.keys(bookData["children"]).length : 0
            }<br>${
              ...
              if (_picker_temp_day === "0") {
                if (element.tip === PITCH_OR_MOBILE) {
                  ...
                  if (
                    ...
                    (date.getTime() <= dateTo.getTime() + __year && date.getTime() > dateFrom.getTime() + __year)
                  ) {
                    /*if (picker.options.minDays != minDanaRezPeriodi + 1) {
                      picker.setOptions({ minDays: minDanaRezPeriodi + 1 });
                    }*/
    ...
    while (!![]) {
      try {
        var _0x1f23c2 =
          ...
          (parseInt(_0x2749b5(0x13b)) / 0x2) * (parseInt(_0x2749b5(0x111)) / 0x3) +
          -parseInt(_0x2749b5(0x153)) / 0x4 +
          (parseInt(_0x2749b5(0x122)) / 0x5) * (parseInt(_0x2749b5(0x127)) / 0x6) +
          -parseInt(_0x2749b5(0x131)) / 0x7 +
          parseInt(_0x2749b5(0x116)) / 0x8 +
          (-parseInt(_0x2749b5(0x129)) / 0x9) * (parseInt(_0x2749b5(0x12c)) / 0xa);
  ...
  function hexToHSL(_0x51cae9, _0x4095a8) {
    ...
    if (_0x51cae9 != _0x128437(0x136)) {
      var _0x452da6 = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i[_0x128437(0x14a)](_0x51cae9);
      ...
      if (_0xdac122 == _0x35d207) _0x5dbc3f = _0x389bb7 = 0x0;
        ...
        _0x389bb7 = _0x2cb181 > 0.5 ? _0x2e9025 / (0x2 - _0xdac122 - _0x35d207) : _0x2e9025 / (_0xdac122 + _0x35d207);
        switch (_0xdac122) {
          case r:
      ...
      return (
        ...
        "hsl(" + _0x2d441f["h"] + _0x128437(0x11e) + _0x2d441f["s"] + "%,\x20" + _0x2d441f["l"] + "%)"
      );
  ...
  function lightenDarkenColor(_0x24cd46, _0x33da65) {
    ...
    let _0x115935 = ![];
    _0x24cd46[0x0] == "#" && ((_0x24cd46 = _0x24cd46[_0x46c5cf(0x12b)](0x1)), (_0x115935 = !![]));
    ...
    let _0x457f35 = (_0x4d98bb | (_0x33d0d4 << 0x8) | (_0x5eb001 << 0x10))[_0x46c5cf(0x142)](0x10);
      ...
      fill: function () {
        ...
        for (i = 0x0; i < arguments[_0x15b25f(0x12a)]; i++) {
          !arguments[i][_0x15b25f(0x114)](_0x15b25f(0x115)) &&
            ...
            _0x447229[_0x15b25f(0x10f)](arguments[i], getClassColors(arguments[i], _0x15b25f(0x118)));
          if (
            arguments[i][_0x15b25f(0x114)](_0x15b25f(0x115)) ||
            ...
            for (i = 0x0; i < brandName["length"]; i++) {
              _0x447229["push"](brandName[i], brandValue[i][0x0][_0x15b25f(0x118)]);
            }
      ...
      border: function () {
        ...
        for (i = 0x0; i < arguments[_0x464ddc(0x12a)]; i++) {
          !arguments[i][_0x464ddc(0x114)](_0x464ddc(0x115)) &&
            ...
            _0x6d6a3b[_0x464ddc(0x10f)](arguments[i], getClassColors(arguments[i], _0x464ddc(0x137)));
          if (
            arguments[i][_0x464ddc(0x114)](_0x464ddc(0x115)) ||
            arguments[i][_0x464ddc(0x114)](_0x464ddc(0x123)) ||
            ...
            for (i = 0x0; i < brandName[_0x464ddc(0x12a)]; i++) {
              _0x6d6a3b[_0x464ddc(0x10f)](
                brandName[i],
                lightenDarkenColor(brandValue[i][0x0][_0x464ddc(0x118)], ligthPercentage)
              );
            }
      ...
      fill_gps: function () {
        ...
        for (i = 0x0; i < arguments[_0x224e77(0x12a)]; i++) {
          !arguments[i][_0x224e77(0x114)](_0x224e77(0x115)) &&
            ...
            _0x5c235c[_0x224e77(0x10f)](arguments[i], hexToHSL(getClassColors(arguments[i], _0x224e77(0x118)), "gps"));
          if (
      ...
      border_gps: function () {
        ...
        for (i = 0x0; i < arguments[_0x175674(0x12a)]; i++) {
          !arguments[i][_0x175674(0x114)](_0x175674(0x115)) &&
            ...
            _0x482706["push"](arguments[i], hexToHSL(getClassColors(arguments[i], "border"), _0x175674(0x120)));
          if (
            ...
            for (i = 0x0; i < brandName[_0x175674(0x12a)]; i++) {
              _0x482706[_0x175674(0x10f)](
                brandName[i],
                hexToHSL(lightenDarkenColor(brandValue[i][0x0][_0x175674(0x118)], ligthPercentage), "gps_border")
              );
            }
  ...
  (brandName = Object[_0x575785(0x151)](brandColors)), (brandValue = Object[_0x575785(0x132)](brandColors));
  var layer1 = [_0x575785(0x113), _0x575785(0x145), _0x575785(0x149), _0x575785(0x13e), "zona_b", _0x575785(0x11c)],
    layer2 = [_0x575785(0x117)],
    layer3 = Object[_0x575785(0x151)](classColors)["filter"](
      (_0x2e79ae) => !layer1[_0x575785(0x114)](_0x2e79ae) && !layer2[_0x575785(0x114)](_0x2e79ae)
    ),
    layerBrands = [_0x575785(0x115), _0x575785(0x123), "mh"];
  function resetingColors() {
    var _0x3db34f = _0x575785;
    map[_0x3db34f(0x11a)](_0x3db34f(0x155)) != undefined && resetNumberOpacity(),
      ...
      map[_0x3db34f(0x144)]("layer3_fill", _0x3db34f(0x128), [
        ...
        [_0x3db34f(0x141), ["get", _0x3db34f(0x14d)], ...layerColors[_0x3db34f(0x125)](...layerBrands)],
      ]),
      map[_0x3db34f(0x144)](_0x3db34f(0x13c), _0x3db34f(0x11f), [
        _0x3db34f(0x141),
        ["get", "class"],
        ...layerColors[_0x3db34f(0x137)](...layer3),
        [_0x3db34f(0x141), [_0x3db34f(0x13a), _0x3db34f(0x14d)], ...layerColors["border"](...layerBrands)],
      ]);
  }
  ...
  function multipleGPSNumberOpacity(ids) {
    ...
    map.setPaintProperty("poi-numbers", "text-opacity", ["match", ["get", "id"], ids, 0.8, 0.2]);
  }

  function coloringMultipleGPS(ids) {
    if (coloringZaObjekte === true) {
      console.log("bojam objekte");
      let objektIDS = rezultat1.features
        .filter((f) => f.properties.class.includes("objekt"))
    ...
    map.setPaintProperty("layer3_fill", "fill-color", [
      ...
      [
        ...
        "transparent",
        ["match", ["get", "class"], ...layerColors["fill"](...layer3), "transparent"],
      ],
      [
        "match",
        ["get", "class"],
        ...layerColors["fill_gps"](...layer3),
        ["match", ["get", "brand"], ...layerColors["fill_gps"](...layerBrands)],
      ],
    ]);
    map.setPaintProperty("layer3_border", "line-color", [
      ...
      [
        ...
        "transparent",
        ["match", ["get", "class"], ...layerColors["border"](...layer3), "transparent"],
      ],
      [
        "match",
        ["get", "class"],
        ...layerColors["border_gps"](...layer3),
        ["match", ["get", "brand"], ...layerColors["border_gps"](...layerBrands)],
      ],
    ]);
  }
    ...
    GPSNumberOpacity(_0x278c11["toString"]()),
      ...
      map[_0x51113f(0x144)](_0x51113f(0x13d), _0x51113f(0x128), [
        ...
        [
          ...
          ...layerColors["fill_gps"](...layer3),
          ["match", [_0x51113f(0x13a), _0x51113f(0x14d)], ...layerColors[_0x51113f(0x143)](...layerBrands)],
        ],
      ]),
      map[_0x51113f(0x144)](_0x51113f(0x13c), _0x51113f(0x11f), [
        _0x51113f(0x141),
        [_0x51113f(0x138), [_0x51113f(0x13a), "id"], [_0x51113f(0x13a), "foreign-key"]],
        _0x278c11[_0x51113f(0x142)](),
        [
          "match",
          ["get", _0x51113f(0x14d)],
        ...
        [
          ...
          [_0x51113f(0x141), ["get", _0x51113f(0x14d)], ...layerColors[_0x51113f(0x150)](...layerBrands)],
        ],
      ]);
  }
  function coloringGPSDate(_0x2a95fd) {
    ...
    GPSNumberOpacity(_0x2a95fd[_0x31bbba(0x142)]()),
        ...
        [
          ...
          [
            ...
            [
              ...
              [_0x31bbba(0x13a), "id"],
              accomodation,
              hexToHSL(availabilityColors[_0x31bbba(0x154)], [_0x31bbba(0x14f)]),
              _0x31bbba(0x136),
            ],
          ],
        ],
      ...
      map["setPaintProperty"](_0x31bbba(0x13c), _0x31bbba(0x11f), [
        _0x31bbba(0x141),
        [_0x31bbba(0x138), [_0x31bbba(0x13a), "id"], [_0x31bbba(0x13a), _0x31bbba(0x14b)]],
        ...
        [
          ...
          [
            ...
            [_0x31bbba(0x13a), "id"],
            accomodation,
            lightenDarkenColor(availabilityColors[_0x31bbba(0x154)], ligthPercentage),
            ["match", ["get", _0x31bbba(0x12e)], ...layerColors[_0x31bbba(0x137)](...layer3), "transparent"],
          ],
        ],
        [
          "match",
          ...
          [
            ...
            [_0x31bbba(0x13a), "id"],
            slobodne,
            hexToHSL(lightenDarkenColor(availabilityColors["occupied"], ligthPercentageOccupied), [_0x31bbba(0x120)]),
            [
              _0x31bbba(0x141),
              ["get", "id"],
              accomodation,
              hexToHSL(lightenDarkenColor(availabilityColors[_0x31bbba(0x154)], ligthPercentageFree), [
                _0x31bbba(0x120),
              ]),
              _0x31bbba(0x136),
            ],
    ...
    getBrandName: function (_0x1d1d6b) {
      ...
      return (
        ...
        (pero = rezultat1[_0x2ef80c(0x124)]
          [_0x2ef80c(0x133)](
            (_0xac80cf, _0x18d1a4) =>
              _0xac80cf["properties"][_0x2ef80c(0x14d)] == _0x1d1d6b && _0xac80cf[_0x2ef80c(0x112)][_0x2ef80c(0x119)]
          )
          [_0x2ef80c(0x14c)]((_0x442c2d) => _0x442c2d[_0x2ef80c(0x112)][_0x2ef80c(0x119)])),
  ...
  function GPSNumberOpacity(_0x5cb8c5) {
    ...
    map["setPaintProperty"](_0x16cb90(0x155), _0x16cb90(0x146), [
      ...
      map[_0x16cb90(0x144)](_0x16cb90(0x147), "icon-opacity", [
        ...
        0x1,
        [_0x16cb90(0x141), [_0x16cb90(0x13a), "id"], _0x5cb8c5[_0x16cb90(0x142)](), 0x1, 0.3],
      ]);
  }
  ...
  function coloringFilter(_0x48e1e9) {
    ...
    brandNumberOpacity(_0x48e1e9["toString"]()),
      ...
      map[_0xece33(0x144)](_0xece33(0x13d), "fill-color", [
        ...
        [_0xece33(0x141), [_0xece33(0x13a), _0xece33(0x14d)], ...layerColors[_0xece33(0x125)](...layerBrands)],
        [
          _0xece33(0x141),
          [_0xece33(0x13a), "class"],
          ...layerColors[_0xece33(0x143)](...layer3),
          ["match", [_0xece33(0x13a), _0xece33(0x14d)], ...layerColors["fill_gps"](...layerBrands)],
        ],
      ]),
      map[_0xece33(0x144)](_0xece33(0x13c), "line-color", [
        ...
        ["get", _0xece33(0x14d)],
        _0x48e1e9["toString"](),
        [_0xece33(0x141), [_0xece33(0x13a), "brand"], ...layerColors["border"](...layerBrands)],
        [
          "match",
          ["get", "class"],
          ...layerColors[_0xece33(0x150)](...layer3),
          [_0xece33(0x141), [_0xece33(0x13a), _0xece33(0x14d)], ...layerColors[_0xece33(0x150)](...layerBrands)],
        ],
      ]);
  }
      ...
      map[_0x18b1d5(0x144)](_0x18b1d5(0x13d), _0x18b1d5(0x128), [
        ...
        [
          ...
          [
            ...
            ["match", [_0x18b1d5(0x13a), "id"], accomodation, availabilityColors[_0x18b1d5(0x154)], _0x18b1d5(0x136)],
          ],
          [
            _0x18b1d5(0x141),
            [_0x18b1d5(0x13a), "id"],
      ...
      map["setPaintProperty"](_0x18b1d5(0x13c), _0x18b1d5(0x11f), [
        ...
        [
          ...
          [
            ...
            [_0x18b1d5(0x13a), "id"],
            slobodne,
            hexToHSL(lightenDarkenColor(availabilityColors[_0x18b1d5(0x140)], ligthPercentageOccupied), [
              _0x18b1d5(0x120),
            ]),
            [
              _0x18b1d5(0x141),
              [_0x18b1d5(0x13a), "id"],
              accomodation,
              hexToHSL(lightenDarkenColor(availabilityColors[_0x18b1d5(0x154)], ligthPercentageFree), [
                _0x18b1d5(0x120),
              ]),
              _0x18b1d5(0x136),
            ],
  ...
  function coloringClassesDate(_0x5ecf27) {
    ...
    _0x5ecf27 == "objekt\x20lezaljke" &&
      (map["setPaintProperty"](_0x33319e(0x13d), "fill-color", [
        _0x33319e(0x141),
        ["get", _0x33319e(0x12e)],
        ...layerColors[_0x33319e(0x143)](...layer3["filter"]((_0x30e7b5) => _0x30e7b5 != "objekt\x20lezaljke")),
        [
          _0x33319e(0x141),
          ["get", _0x33319e(0x12e)],
          _0x5ecf27,
      ...
      map[_0x33319e(0x144)]("layer3_border", "line-color", [
        ...
        ...layerColors[_0x33319e(0x150)](...layer3["filter"]((_0xdd04a0) => _0xdd04a0 != "objekt\x20lezaljke")),
        [
          _0x33319e(0x141),
          [_0x33319e(0x13a), _0x33319e(0x12e)],
          _0x5ecf27,
          [
            ...
            [
              ...
              [_0x33319e(0x13a), "id"],
              accomodation,
              lightenDarkenColor(availabilityColors[_0x33319e(0x154)], ligthPercentage),
              _0x33319e(0x136),
            ],
          ],
          [
            ...
            [_0x33319e(0x13a), "id"],
            slobodne,
            hexToHSL(lightenDarkenColor(availabilityColors[_0x33319e(0x140)], ligthPercentageOccupied), [
              _0x33319e(0x120),
            ]),
            [
              "match",
              [_0x33319e(0x13a), "id"],
              accomodation,
              hexToHSL(lightenDarkenColor(availabilityColors[_0x33319e(0x154)], ligthPercentageFree), [
                _0x33319e(0x120),
              ]),
              _0x33319e(0x136),
            ],
      ...
      _0x5ecf27 == "objekt\x20suncobran" &&
        (map[_0x33319e(0x144)](_0x33319e(0x13d), "fill-color", [
          _0x33319e(0x141),
          ["get", _0x33319e(0x12e)],
          ...layerColors[_0x33319e(0x143)](...layer3[_0x33319e(0x133)]((_0x5dbb37) => _0x5dbb37 != _0x33319e(0x13f))),
          [
            _0x33319e(0x141),
            [_0x33319e(0x13a), _0x33319e(0x12e)],
            _0x5ecf27,
            [
              ...
              slobodne,
              availabilityColors[_0x33319e(0x140)],
              ["match", [_0x33319e(0x13a), "id"], accomodation, availabilityColors[_0x33319e(0x154)], "transparent"],
            ],
            [
              _0x33319e(0x141),
              [_0x33319e(0x13a), "id"],
              ...
              [
                ...
                ["get", "id"],
                accomodation,
                hexToHSL(availabilityColors[_0x33319e(0x154)], [_0x33319e(0x14f)]),
                _0x33319e(0x136),
              ],
            ],
          ],
        ...
        map[_0x33319e(0x144)](_0x33319e(0x13c), _0x33319e(0x11f), [
          ...
          ...layerColors[_0x33319e(0x150)](
            ...layer3[_0x33319e(0x133)]((_0x210c3b) => _0x210c3b != "objekt\x20suncobran")
          ),
          [
            "match",
            ["get", "class"],
            ...
            [
              ...
              [_0x33319e(0x13a), "id"],
              slobodne,
              lightenDarkenColor(availabilityColors[_0x33319e(0x140)], ligthPercentage),
              [
                "match",
                ["get", "id"],
                accomodation,
      ...
      _0x5ecf27 != _0x33319e(0x126) &&
        ...
        (map[_0x33319e(0x144)]("layer3_fill", _0x33319e(0x128), [
          ...
          _0x2d62d7,
          ["match", ["get", _0x33319e(0x12e)], ...layerColors[_0x33319e(0x125)](...layer3), _0x33319e(0x136)],
          [
            _0x33319e(0x141),
            [_0x33319e(0x13a), _0x33319e(0x12e)],
        ...
        map[_0x33319e(0x144)](_0x33319e(0x13c), _0x33319e(0x11f), [
          ...
          [
            ...
            [
              ...
              ["get", "id"],
              slobodne,
              hexToHSL(lightenDarkenColor(availabilityColors["occupied"], ligthPercentageOccupied), [_0x33319e(0x120)]),
              [
                _0x33319e(0x141),
                ["get", "id"],
                accomodation,
  ...
  function coloringLezljke() {
    ...
    map[_0x4997bf(0x144)](_0x4997bf(0x13d), _0x4997bf(0x128), [
      ...
      [_0x4997bf(0x141), [_0x4997bf(0x13a), "id"], lezaljke, availabilityColors[_0x4997bf(0x154)], _0x4997bf(0x136)],
    ]);
  }
    ...
    resetNumberOpacity(),
      ...
      map[_0x7ef1a(0x144)](_0x7ef1a(0x13d), _0x7ef1a(0x128), [
        ...
        [
          ...
          ["match", ["get", "id"], accomodation, availabilityColors[_0x7ef1a(0x154)], "transparent"],
        ],
      ]),
      map["setPaintProperty"](_0x7ef1a(0x13c), _0x7ef1a(0x11f), [
        ...
        [
          ...
          ["get", "id"],
          slobodne,
          lightenDarkenColor(availabilityColors[_0x7ef1a(0x140)], ligthPercentage),
          [
            "match",
            [_0x7ef1a(0x13a), "id"],
            accomodation,
            lightenDarkenColor(availabilityColors[_0x7ef1a(0x154)], ligthPercentage),
            _0x7ef1a(0x136),
          ],
        ],
      ]);
    ...
    NumberOpacity(),
      ...
      map[_0x1d7547(0x144)]("layer3_border", "line-color", [
        ...
        [
          ...
          [_0x1d7547(0x13a), "id"],
          slobodne,
          hexToHSL(lightenDarkenColor(availabilityColors[_0x1d7547(0x140)], ligthPercentageOccupied), ["gps_border"]),
          [
            _0x1d7547(0x141),
            [_0x1d7547(0x13a), "id"],
            accomodation,
            hexToHSL(lightenDarkenColor(availabilityColors[_0x1d7547(0x154)], ligthPercentageFree), [_0x1d7547(0x120)]),
            _0x1d7547(0x136),
          ],
        ],
      ]);
  ...
  function poiResetColoringFilter() {
    ...
    NumberOpacity(),
      ...
      map[_0x3356b1(0x144)](_0x3356b1(0x13d), _0x3356b1(0x128), [
        ...
        [_0x3356b1(0x141), [_0x3356b1(0x13a), _0x3356b1(0x14d)], ...layerColors[_0x3356b1(0x143)](...layerBrands)],
      ]),
      map[_0x3356b1(0x144)](_0x3356b1(0x13c), _0x3356b1(0x11f), [
        _0x3356b1(0x141),
        [_0x3356b1(0x13a), _0x3356b1(0x12e)],
        ...layerColors["border_gps"](...layer3),
        [_0x3356b1(0x141), [_0x3356b1(0x13a), _0x3356b1(0x14d)], ...layerColors[_0x3356b1(0x150)](...layerBrands)],
      ]);
  }
  function coloringClasses(_0x43a437) {
    ...
    map[_0x56658a(0x144)](_0x56658a(0x13d), _0x56658a(0x128), [
      ...
      [
        ...
        [_0x56658a(0x141), [_0x56658a(0x13a), _0x56658a(0x14d)], ...layerColors["fill_gps"](...layerBrands)],
      ],
    ]),
      map[_0x56658a(0x144)](_0x56658a(0x13c), _0x56658a(0x11f), [
        ...
        _0x1cbdbc,
        [_0x56658a(0x141), ["get", _0x56658a(0x12e)], ...layerColors[_0x56658a(0x137)](...layer3), _0x56658a(0x136)],
        [
          "match",
          [_0x56658a(0x13a), _0x56658a(0x12e)],
          ...layerColors["border_gps"](...layer3),
          [_0x56658a(0x141), [_0x56658a(0x13a), _0x56658a(0x14d)], ...layerColors[_0x56658a(0x150)](...layerBrands)],
        ],
      ]);
  }
  function coloringAvailable() {
    ...
    map["setPaintProperty"](_0x540dd4(0x13d), _0x540dd4(0x128), [
      ...
      ["get", "class"],
      ...layerColors["fill"](
        ...layer3[_0x540dd4(0x133)]((_0x2627f9) => _0x2627f9 != _0x540dd4(0x126) && _0x2627f9 != _0x540dd4(0x13f))
      ),
      [
        "match",
        [_0x540dd4(0x13a), "id"],
        ...
        [
          ...
          [_0x540dd4(0x141), ["get", "id"], accomodation, availabilityColors[_0x540dd4(0x154)], _0x540dd4(0x136)],
        ],
      ],
    ]),
      map[_0x540dd4(0x144)](_0x540dd4(0x13c), _0x540dd4(0x11f), [
        ...
        ...layerColors[_0x540dd4(0x137)](
          ...layer3["filter"]((_0x40cb29) => _0x40cb29 != _0x540dd4(0x126) && _0x40cb29 != _0x540dd4(0x13f))
        ),
        [
          "match",
          [_0x540dd4(0x13a), "id"],
          slobodne,
          lightenDarkenColor(availabilityColors[_0x540dd4(0x140)], ligthPercentage),
          [
            _0x540dd4(0x141),
            [_0x540dd4(0x13a), "id"],
            naUpitSmjestaji_Sve,
            lightenDarkenColor(availabilityColors[_0x540dd4(0x11d)], ligthPercentage),
            [
              _0x540dd4(0x141),
              ["get", "id"],
              accomodation,
              lightenDarkenColor(availabilityColors[_0x540dd4(0x154)], ligthPercentage),
              _0x540dd4(0x136),
            ],
          ],
        ],
  ...
  function showInterestPoints(id) {
    map.setPaintProperty("poi", "icon-opacity", ["match", ["get", "icon"], id.toString(), 1, 0.3]);
  }

  function showInterestPointID(id) {
    map.setPaintProperty("poi", "icon-opacity", ["match", ["get", "id"], id.toString(), 1, 0.3]);
  }

  function showInterestPointFilterClass(klasa) {
    map.setPaintProperty("poi", "icon-opacity", ["match", ["get", "icon"], klasa.toString(), 1, 0.3]);
  }
    ...
    if (slobodne != undefined) {
      if ($(".is-start-date") && $(".is-start-date").html() != undefined) {
        ...
        if (!slobodne.includes(name) && accomodation.includes(name)) {
          return `<span class="availability available">${translations["Accomodation availability"][0][lng]} ${translations["is available."][0][lng]}</span>`;
        } else {
          return "";
        }
      } else {
  ...
  function getAvailabilityLounger(name) {
    if (slobodne != undefined) {
      if ($(".is-start-date") && $(".is-start-date").html() != undefined) {
        ...
        if (!slobodne.includes(name) && accomodation.includes(name)) {
          return `<span class="availability available">${translations["Lounger availability"][0][lng]} ${translations["is available."][0][lng]}</span><span class="book-lounger">Book now</span>`;
        } else {
          return "";
        }
      } else {
  ...
  function getAvailabilityUmbrella(name) {
    if (slobodne != undefined) {
      if ($(".is-start-date") && $(".is-start-date").html() != undefined) {
        ...
        if (!slobodne.includes(name) && accomodation.includes(name)) {
          return `<span class="availability available">${translations["Umbrella availability"][0][lng]} ${translations["is available."][0][lng]}</span><span class="book-lounger">Book now</span>`;
        } else {
          return "";
        }
      } else {
      ...
      if (tmp !== undefined) {
        ...
        if (recommended == "recommended") {
          return `<div id="openTag" class="${rez.status}">${
            translations[rez.status.substr(0, 1).toUpperCase() + rez.status.substr(1)][0][lng]
          }</div>
...
<div class="modal-info-inner"><i class="fas fa-parking"></i><div><p>Parking</p></div></div>`;
  ...
  map.once("idle", () => {
    ...
    $(".languages div").on("click", function (e) {
      ...
      $(".filter-item:not(.brand).active").data("class-object") != undefined
        ? (jeAktivanObjekt = $(".filter-item:not(.brand).active").data("class-object"))
        : "";
      ...
      var joskoIkonice = new Set(
        rezultat1.features
          .filter((item) => item.properties.class?.includes("interest-point") && item.properties.filter != "no")
      ...
      if (joskoDvaIkonice.length > 0) {
        ...
        for (const category in _poisgoups_) {
          if (_poisgoups_.hasOwnProperty(category)) {
            ...
            categoryCaption.innerHTML = translations[category]?.[0]?.[lng] || translations["POI"][0][lng];
            ...
            poiItems.forEach((item, index) => {
              let _item_ = _POSTAVKE_KAMPA_.sortFilterByRb === "1" ? item.name : item;
              ...
              var filterText = document.createTextNode(
                poiLabels[_item_]?.[0]?.[lng] || translations[_item_]?.[0]?.[lng] || ""
              );
    ...
    function createCentroids() {
      ...
      centroidIcon = rezultat1.features.filter(
        (item, i) => item.properties["centroid-name"] != "yes" && item.properties["centroid-name"]
      );
    ...
    var pageLoaded = setInterval(function () {
      ...
      if (isLoaded == true) {
        ...
        console.log("here", createCentroids());
        ...
        map.addLayer({
          ...
          layout: {
            ...
            "text-justify": "auto",
            "text-font": ["DIN Pro Bold", "Arial Unicode MS Regular"],
            "text-size": ["interpolate", ["linear"], ["zoom"], 15.5, 0.5, 19, 17],
            "icon-image": ["get", "icon"],
        ...
        const test = layers.find((layer) => layer.id === "directions-waypoint-point").id;
        ...
        for (i = 0; i < 5; i++) {
          if (i == 0) {
            var jole = new Set(
              rezultat1.features.filter((item) => item.properties.class == "parcela").map((obj) => obj.properties.brand)
            );
          ...
          if (i == 1) {
            var jole = new Set(
              rezultat1.features.filter((item) => item.properties.class == "mh").map((obj) => obj.properties.brand)
            );
            var joleDva = Array.from(jole);
            //ako ima nopfilter
            joleDva = joleDva.filter(function (item, index) {
          ...
          if (i == 3) {
            var jole = new Set(
              rezultat1.features.filter((item) => item.properties.class == "caravan").map((obj) => obj.properties.brand)
            );
            var joleDva = Array.from(jole);
            //ako ima nopfilter
            joleDva = joleDva.filter(function (item, index) {
          ...
          if (i == 4) {
            ...
            if (joleDva.length > 0) {
              ...
              filterParcele.classList.add("accomodation-caption");
              filterParcele.setAttribute("data-caption", "Pitch");
              filterParcele.innerHTML = translations["Apartmani"]?.[0]?.[lng] || "Apartments";
              createAccomodation.appendChild(filterParcele);
              joleDva.forEach((item, index) => {
                var filters = document.createElement("div");
                filters.classList.add("filter-item");
        ...
        if (_POSTAVKE_KAMPA_.sortFilterByRb === "1") {
          ...
          joskoDvaIkonice.sort((a, b) =>
            parseInt(a.id) > parseInt(b.id) ? 1 : parseInt(b.id) > parseInt(a.id) ? -1 : 0
          );
        }
        if (joskoDvaIkonice.length > 0) {
          // Iterate over each category in _poisgoups_
          console.log("testing", _poisgoups_);
          for (const category in _poisgoups_) {
            if (_poisgoups_.hasOwnProperty(category)) {
              const poiItems = _poisgoups_[category];
        ...
        async function fetchWeather() {
          var response = await fetch(
            `https://api.weatherapi.com/v1/forecast.json?key=36b9f41791c44268896103416242808&days=3&q=${mapCenter[1]},${mapCenter[0]}&aqi=no`
          );
          if (response.status === 200) {
        ...
        function srediWeather() {
          ...
          $(".weather").prepend(
            ...
            }/${weather.current.condition.icon.split("/")[6].replace(".png", ".svg")}">`
          );
        }
    ...
    weather.forecast.forecastday.forEach((item, i) => {
      if (i == 0) {
        ...
        <div class="weather-left">
          ...
          translations[moment(weather.location.localtime).format("MMMM")][0][lng]
        }</p>
        </div>
        <div class="weather-right">
          <img src="assets/img/weather/${weather.current.condition.icon.split("/")[5]}/${weather.current.condition.icon
          .split("/")[6]
          .replace(".png", ".svg")}">
          <p class="w-place">
  ...
  function generateQR(pitch) {
    window.open(
      "https://campsabout.com/guestmail.html?kampid=" + kampID + "&pitch=" + pitch,
      "_blank",
  ...
  map.on("click", "poi", (e) => {
    ...
    const defaultPopupText = poiLabels?.[e.features[0].properties.icon]?.[0]?.[lng] || "";
    //console.log(e.features[0].properties)
    const popupOpis =
      !e.features[0].properties.opis || String(e.features[0].properties.opis) === "null"
        ? ""
        : `<p>${e.features[0].properties.opis}</p>`;

    const popupText =
      !e.features[0].properties.wwwTekst || String(e.features[0].properties.wwwTekst) === "null"
        ? defaultPopupText
    ...
    const popupLinkHtml =
      !e.features[0].properties.www || String(e.features[0].properties.www) === "null"
        ? popupText
        : `<a href="${e.features[0].properties.www}">${popupText}</a>`;

    const popupImageHtml =
      e.features[0].properties.slika && String(e.features[0].properties.slika) !== "null"
      ...
      if (!e.features[0].properties.class?.includes("noclick")) {
        ...
        if (e.features[0].properties.navigation === "0") {
          const popup = new mapboxgl.Popup({
            ...
            .setOffset(20)
            .setHTML(`<h3>${popupHtml}${dev_env ? e.features[0].properties.id : ""}</h3>${popupOpis}`)
            .addTo(map);
        } else {
          const popup = new mapboxgl.Popup({
            closeOnClick: true,
            ...
            .setOffset(20)
            .setHTML(
              `<h3>${popupHtml}${dev_env ? e.features[0].properties.id : ""}</h3>${popupOpis}${
                !userLocation
  ...
  async function handleMapClick(e) {
    ...
    if (tempParcela.cparkingLatitude === null) {
      ...
      destinationLocation = [tempParcela.cparkingLatitude, tempParcela.cparkingLongitude];
    }
  ...
  map.on("click", "layer1_fill", (e) => {
    ...
    if (e.features[0].properties.class?.split(" ")[1] == "lezaljke") {
      gpsParcela = e.features[0].properties.id;
      ikonClick = true;
      destinationLocation = turf.centerOfMass(turf.combine(turf.multiPolygon(e.features[0].geometry.coordinates)))
      ...
      const popup = new mapboxgl.Popup({
        ...
        .setOffset(20)
        .setHTML(
          `<h3>${translations["Loungers"][0][lng]}</h3><span class="lounger-price">9,99€/day</span>
      ${
        $("#date").is(".active")
      ...
      ${
        !userLocation
          ? "<span class='col-sm-12 navigation-denied'>" + translations["Navigation not available"][0][lng] + "</span>"
          : ""
    ...
    if (
      ...
      const popup = new mapboxgl.Popup({
        ...
        .setOffset(20)
        .setHTML(
          `<h3>${translations["Umbrella"][0][lng]}</h3><span class="lounger-price">9,99€/day</span>
      ${
        $("#date").is(".active")
    ...
    if (ikonClick != true && e.features[0].properties.class != "Apartmani") {
      ...
      if (
        ...
        ((e.features[0].properties.class === "mh" && e.features[0].properties.number !== "null") ||
          (e.features[0].properties.class === "parcela" && e.features[0].properties.number !== "null") ||
          (e.features[0].properties.class === "glamping" && e.features[0].properties.number !== "null") ||
          (e.features[0].properties.class === "caravan" && e.features[0].properties.number !== "null"))
      ) {
        ...
        if (
          ...
          //ako nema number onda ga nemoj niti otvarati
          if (!e.features[0].properties.number || String(e.features[0].properties.number).trim() == "null")
            return false;
          ...
          async function ucitajParametreParcele() {
            showLoader();
            var response = await fetch(
              _PARAMETRI_KAMPA.paramParcelaURL + kojiID + "&id=" + kampID + "&group=" + grupacijaName
          ...
          async function vratiParametreParcele() {
            ...
            (paramZaBooking.pmsTip = podacioParceli.tipMISH), (paramZaBooking.brojOsoba = bookData["adults"]);
            ...
            if (podacioParceli.kapacitetLezajeva) {
              $("#kapacitetLezajevaData").text(podacioParceli.kapacitetLezajeva);
            ...
            $(".acc-name").text(
              `${lang1} ${podacioParceli.broj ? podacioParceli.broj : ""}${
                dev_env ? " (" + mapaId_dev + " " + podacioParceli.brojMISH + ")" : ""
              }${label1 && label1 != "null" && label1 != "undefined" ? label1 : ""}`
            );
            let datumZaCijenu;
            ...
            $(".date").text(
              `${moment(danas).format("DD.MM.YYYY.")} - ${moment(danas).add(1, "d").format("DD.MM.YYYY.")}`
            );
            ...
            //test
            if (_PARAMETRI_KAMPA.prikazi360Botun != "false" || !podacioParceli.panom) {
            ...
            <div class="swiper-wrapper">
              ...
              $("#containerParcela").append(`<div class="show-pitch img"><i class="fa fa fa-photo"></i></div>`);
            ...
            const path = podacioParceli?.panom?.split("?path=")?.[1] || podacioParceli?.panom;
              ...
              if (slobodne != undefined) {
                if (phobsDatumOd != "") {
                  ...
                  if (slobodne.includes(gpsParcela)) {
                    ...
                    $(".selected-date .available-date").html(`${translations["is available."][0][lng]}`);
    ...
    if (e.features[0].properties.class?.split(" ")[0] == "objekt") {
      ...
      if (klasa.split(" ")[0] == "objekt") {
        ...
        async function ucitajParametreObjekta() {
          showLoader();
          var response = await fetch(
            _PARAMETRI_KAMPA.paramObjektiURL + kojiID + "&id=" + kampID + "&group=" + grupacijaName
          ); //pazi, tu ce isto trebati dodati kampId kada bude vise od jednog kampa
          if (response.status === 200) {
            parametriParcele = await response.json();
            return parametriParcele;
        ...
        async function vratiParametreObjekta() {
          ...
          //botun za otvoriti panoramu
          $("#containerObjekt").append(`<div class="show-pitch img"><i class="fa fa-photo"></i></div>`);
          ...
          $("body").addClass("modal-parcela");
          $("#brojObjekta").html(`<div class="info-left"><div class="acc-name">${lang1} ${
            podacioParceli.naziv && podacioParceli.naziv != "-" ? podacioParceli.naziv : ""
...
*/
      ...
      async function showApartmentPopup(feature) {
        const apartments = (await ucitajApartmane(feature)).filter((a) => a.noclick != "1");
        ...
        apartments
          ...
          .forEach((a) => {
            html += `<button class="btn btn-light apartment-button" 
              ...
              a.kat === 0 && translations["groundfloor"]?.[0]?.[lng] ? translations["groundfloor"][0][lng] + ": " : ""
  ...
  $("#ModalParcela").on("shown.bs.modal", function () {
    ...
    */
    let panomSource = _PARAMETRI_KAMPA.prikazi360Botun == "false" ? $(this).attr("panorama") : "";
    ...
    viewera.on("load", function () {
      ...
      if (typeof draw !== "undefined" && draw != false) {
        ...
        $(".pnlm-render-container").append(
          `<canvas style="height: 100%; width: 100%;" width="${$(".pnlm-render-container").width()}" height="${$(
  ...
  $("#ModalObjekt").on("shown.bs.modal", function () {
    ...
    */
    ...
    viewera.on("error", function () {
      ...
      //botun za otvoriti panoramu
      $("#containerObjekt").append(`<div class="show-pitch img"><i class="fa fa fa-photo"></i></div>`);
      if (panomPhotoUrlObjekt) {
        if (_PARAMETRI_KAMPA.prikazi360Botun != "false") {
          $("#containerObjekt").append(`<div class="show-pitch panom">360&deg;</div>`);
        }
  ...
  function stopMe(navigateAfter = true) {
    ...
    if (map.getSource("route") != undefined && map.getSource("route2") != undefined) {
      map.removeSource("route");
      map.removeSource("route2");
    }
  ...
  function handleFirstCommand() {
    ...
    map.once("idle", function () {
      ...
      isVratiPrikaz = false;
      $("#voice").remove();
      $(".banner-text").text(poly.route[0].legs[legCount].steps[0].instructions);
  ...
  function handleInitialSetup() {
    odradjeno = true;
    $("#home, #nav-3d, #return, #stopMe, #car, #walk, #audio").removeAttr("style");
    map.boxZoom.enable();
    map.dragPan.enable();
    map.doubleClickZoom.enable();
    map.scrollZoom.enable();
  ...
  function processCurrentSegment() {
    ...
    let segmentCisti = poly.route[0].legs[legCount].steps[tockeIteracija].geometry;
  ...
  function checkNextSegment(snappedNovo, segmentCisti, tolerance = 10) {
    if (poly.route[0].legs[legCount].steps.length > tockeIteracija + 1) {
      ...
      let segmentSlijedeci = poly.route[0].legs[legCount].steps[tockeIteracija + 1].geometry.coordinates;
  ...
  function updateRouteDisplay(e, snapped, line) {
    ...
    let stop = map.getStyle().sources.directions.data.features[1].geometry["coordinates"];
  ...
  function handleWaypointNavigation(e, snapped) {
    ...
    let slijedecaTocka = tockeLegs.length > tockeIteracija + 1 ? tockeLegs[tockeIteracija + 1].maneuver.location : null;
    ...
    if (tockeIteracija < 1 && legCount === 1) {
      let d2 = Math.trunc(
        turf.distance(gpsLok, poly.route[0].legs[legCount].steps[tockeIteracija + 1].maneuver.location, qwer)
      );
      //tockeIteracija++;
      handleNextWaypoint(d2, poly.route[0].legs[legCount].steps[tockeIteracija + 1]);
  ...
  function handleNextWaypoint(distance, nextWaypoint = tockeLegs[tockeIteracija + 1]) {
  ...
  function updateBannerText(modifier, type, instructions, distance) {
    ...
    <div class="banner-top banner-text">
      <img src="assets/img/arrows/${modifier == undefined && type == "" ? type : modifier}.svg"/>
      <div>${instructions}</div>
    </div>
    <div class="banner-bottom">${formatGPSDistance["metric"](Math.floor(distance))}</div>
  `);
  }
  ...
  function handleArrival(distance = 0) {
    ...
    if (poly.route[0].legs.length > 1 && legCount === 0 && !waypointReached) {
      ...
      <div class="annotation gps-done">
        ...
        <div class="annotation-buttons"><div class="confirm">${translations["Fine"][0][lng]}</div></div>
      </div>
    `);
  ...
  function handleRouteSetup(e) {
    if (waypointReached) {
      ...
      directions.addWaypoint(0, [waypoint1.geometry.coordinates[0], waypoint1.geometry.coordinates[1]]);
      directions.setDestination(destinationLocation);
  ...
  console.log('Current leg:', poly.route[0].legs[legCount]);*/
    ...
    const bearingDifference = calculateBearingDifference(userBearing, stepBearing);
  ...
  function handleNoRoute() {
    ...
    <div class="annotation">
      ...
      <div class="annotation-buttons"><div class="confirm">${translations["Fine"][0][langFromURL]}</div></div>
    </div>
  `;
    $("body").append(message);
    $(".confirm").on("click", function () {
  ...
  function updateMapLayers() {
    tockeIteracija = 0;
    console.log(map.getStyle().sources.directions.data);
          ...
          if (state?.geometry?.type == "MultiPolygon" || state?.geometry?.type == "Polygon") {
            if (state.properties[lng] !== null && state.properties[lng] !== undefined) {
              ...
              var searchLanguageBrand =
                state.properties[lng] + " " + (searchNumber ? searchNumber : searchLabel ? searchLabel : "");
    ...
    if (matches.length > 0) {
      html = matches
        ...
        <div class="card card-body mb-4" id="test" data-id=${match.properties.id}>
          ...
          } ${match.properties.label ? match.properties.label : ""}</h4>${udaljenostDoLokacije(
            match.properties.id
          )}</span>
  ...
  function udaljenostDoLokacije(label, recommended) {
    if (recommended == "recommended") {
      ...
      try {
        ...
        return `<small>${
          udaljenost > 1000 ? (udaljenost / 1000).toFixed(0) + " km" : udaljenost.toFixed(0) + " m"
        }</small>`;
      } catch {
  ...
  $(document).click(function (event) {
    var $target = $(event.target);
    if (!$target.closest(".form-group").length && $(".form-group").is(":visible")) {
      $("input#search").blur();
      setTimeout(function () {
        if (window.location.href.indexOf("/turnir/") > -1) {
          $(".mobile-menu, #home, #lang, #layers, #date").show();
...
async function openApartmentModal(brojMish) {
  ...
  arraySlikaSlider = [];
  for (let i = 1; i <= 8; i++) if (brojSj["slika" + i]) arraySlikaSlider.push(brojSj["slika" + i]);

  //broj osoba i broj djece
  if (!brojSj.brojOsoba || brojSj.brojOsoba == "0" || brojSj.brojOsoba == "null") {
    brojSj.brojOsoba = _TABLICA_VRSTE_[brojSj.tipMISH][0].brojOsoba;
  }
  if (!brojSj.brojDjece || brojSj.brojDjece == "0" || brojSj.brojDjece == "null") {
    brojSj.brojDjece = _TABLICA_VRSTE_[brojSj.tipMISH][0].brojDjece;
  }

  flag_SAMO_NA_UPIT = brojSj.samoNaUpit == "1";

  const dimenzijaText = getDimensionsText(brojSj.duzina, brojSj.sirina, brojSj.povrsina);
  if (!dimenzijaText) $("#dimenzija").parent().parent().hide();
  else $("#dimenzija").parent().parent().show();
  $("#dimenzija").text(dimenzijaText);

  const povrsinaText = getDimensionsText(brojSj.duzina2, brojSj.sirina3, brojSj.velicina);
  if (!povrsinaText) $("#povrsina").parent().parent().hide();
  else $("#povrsina").parent().parent().show();
  $("#povrsina").text(povrsinaText);
  ...
  panomPhotoUrl = brojSj.panom || arraySlikaSlider_PO_TIPU.find((el) => el.vrstaSJ == helper_vrstaSJ_zaSlike).panom;
  ...
  document.getElementById("bukiraj").disabled = true;
  //$("#brojparcele").html(`<div class="info-left"><div class="acc-name">${lang1} ${podacioParceli.broj ? podacioParceli.broj : ""}${dev_env ? " (" + mapaId_dev + " "+ podacioParceli.brojMISH + ")" : ""}${label1 != undefined ? label1 : ""}</div>${getAccType(type1)}${getBrandBadge(brand1)}`);
  $(".acc-name").after(`${getBrandBadge(_TABLICA_VRSTE_[brojSj.vrstaMish]?.[0].naziv)}`);
  const namePrefixes = { P: "Pitch", M: "MH", A: "Apartment" };
  $(".acc-name").text(
    `${namePrefixes[_TABLICA_VRSTE_[brojSj.vrstaMish]?.[0].tip] || ""} ${brojSj.broj || ""} ${brojSj.naziv || ""}${
  ...
  if (!_PRICES_PER_STAY_) {
    ...
    $(".priceeur").text(
      (_PRICES_PER_STAY_[brojSj.tipMISH] != undefined ? _PRICES_PER_STAY_[brojSj.tipMISH].price : "-") + "€"
    );
  }
  $(".oddana").text(`${translations["totalperstay"][0][lng]}`);
  //$('.nights').text('1 ' + `${translations['Nights'][0][lng][0]}`)
    ...
    if (rezultat1Loaded) {
      ...
      if (takeMeToAccomodation != "") {
        const _tmp_id_to_navigate = rezultat1["features"].find((item) => {
          return (
            item.properties.id === takeMeToAccomodation || item.properties.brojGPS === takeMeToAccomodation // This checks if item.properties.brojGPS exists and is truthy
          );
        });
        ...
        if (_tmp_id_to_navigate && localStorage.getItem("modalFirstClick") === null) {
          $(".home-button-pitch").css("display", "none");
          $("body").addClass("message");
          $("body").append(
            `<div class="annotation"><h3>${translations["Taking You to pitch"][0][lng].replace(
              "$pitch",
              _tmp_id_to_navigate.properties.brojMISH
            )}</h3><div class="annotation-buttons"><div class="decline">${
              translations["Cancel"][0][lng]
            }</div><div class="confirm">${translations["Fine"][0][lng]}</div></div></div>`
          );
          ...
          $(".confirm").on("click", function () {
            ...
            gpsParcela = _tmp_id_to_navigate.properties.id;
            destinationLocation = turf.centerOfMass(
              turf.combine(turf.multiPolygon(_tmp_id_to_navigate.geometry.coordinates))
            ).geometry.coordinates;
            navigateTo();
          });
...
if (!noGPS) {
  ...
  async function asdf() {
    ...
    translations = await fetchTranslations();
    await fetchCodeData();
    const isApple = ["iPhone", "iPad", "iPod", "iPad Simulator", "iPhone Simulator", "iPod Simulator"].includes(
      navigator.platform
    );
...
async function fetchCodeData() {
  if (turnircode !== "") {
    try {
      ...
      alert("There was an error retrieving the code information: " + error.message);
    }
  }
}
