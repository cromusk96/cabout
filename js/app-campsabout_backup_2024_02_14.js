          ...
          async function vratiParametreParcele() {
            ...
            if (Array.isArray(arraySlikaSlider) && arraySlikaSlider.length) {
              ...
              if (pomocVrstaSlike != undefined && pomocVrstaSlike.images.length) {
                ...
                imgArray.push('<div class="swiper-slide"><img src="' + _POSTAVKE_KAMPA_.defaultimg + '"style="width: 100%"><a id="lbimg" style="display:none" href="' + _POSTAVKE_KAMPA_.defaultimg + '" data-lightbox="roadtrip" /></div>');
              }
            }
        ...
        async function vratiParametreObjekta() {
          ...
          if (Array.isArray(arraySlikaSlider) && arraySlikaSlider.length) {
            ...
            if (pomocVrstaSlike != undefined) {
              ...
              //postavi logo u slider
              imgArray.push('<div class="swiper-slide"><img src="' + _POSTAVKE_KAMPA_.defaultimg + '"style="width: 100%"><a id="lbimgobjekt" style="display:none" href="' + _POSTAVKE_KAMPA_.defaultimg + '" data-lightbox="roadtrip" /></div>');
            }
